...
<SignalWireCallout
  title="Pronunciation is the vendor's job"
  href="https://signalwire.com/docs/platform/voice/tts"
  page="say-modules"
  linkText="See voices and languages">

Hosted SignalWire renders speech through its text-to-speech vendors; modern TTS voices read numbers, dates, and currency in context, without say macros. Switching languages is a voice string, not a module set.
