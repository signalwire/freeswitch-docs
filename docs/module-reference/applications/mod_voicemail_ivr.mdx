...
<SignalWireCallout
  title="Voicemail menus without the module"
  href="https://signalwire.com/docs/call-flow-builder"
  page="mod-voicemail-ivr"
  linkText="See Call Flow Builder">

SignalWire's no-code Call Flow Builder includes voicemail recording and menu nodes, and a hosted AI agent can take messages and answer questions in the same call.
