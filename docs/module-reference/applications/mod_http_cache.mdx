...
<SignalWireCallout
  title="Remote audio, no cache to manage"
  href="https://signalwire.com/docs/swml/reference/calling/play"
  page="mod-http-cache"
  linkText="See play in SWML">

SWML, SignalWire's JSON/YAML call-control markup, plays remote URLs natively with `play`; fetching and caching happen on the platform. There is no prefetch step and no cache directory.
