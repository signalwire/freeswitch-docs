...
<SignalWireCallout
  title="Beep detection as a method"
  href="https://signalwire.com/docs/swml/reference/calling/detect-machine"
  page="mod-avmd"
  linkText="See detect_machine in SWML">

Hosted SignalWire runs answering-machine and beep detection with the `detect_machine` method of SWML, a JSON/YAML call-control markup. Results arrive as variables your document branches on.
