...
<SignalWireCallout
  title="Caller ID lookup as an API"
  href="https://signalwire.com/docs/platform/phone-numbers"
  page="mod-cidlookup"
  linkText="See phone number management">

SignalWire returns carrier and caller-name data for a number by REST request, usable from any language. There is no lookup module and no cache database to configure.
