...
<SignalWireCallout
  title="The CDR receiver you never build"
  href="https://signalwire.com/docs/apis"
  page="mod-json-cdr"
  linkText="See the REST APIs">

SignalWire keeps call logs queryable by REST API and pushes call status to webhooks as events happen. The JSON is already structured, and there is no receiver to host.
