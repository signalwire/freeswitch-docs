...
<SignalWireCallout
  title="Events without the broker"
  href="https://signalwire.com/docs/server-sdks/guides/relay-client"
  page="mod-amqp"
  linkText="See the RELAY realtime SDK">

SignalWire pushes call and message events to webhooks and to RELAY, a realtime WebSocket API, directly. There is no broker to operate between the switch and your consumers.
