...
<SignalWireCallout
  title="Event control without the Erlang node"
  href="https://signalwire.com/docs/server-sdks/guides/relay-client"
  page="mod-erlang-event"
  linkText="See the RELAY realtime SDK">

RELAY, SignalWire's realtime WebSocket API, delivers events and accepts commands from your own services, with typed SDKs. The distributed-control pattern this module serves is the hosted platform's native model.
