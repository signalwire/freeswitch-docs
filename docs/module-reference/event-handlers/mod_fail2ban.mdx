...
<SignalWireCallout
  title="The scanners never reach you"
  href="https://signalwire.com/docs/platform/voice/sip/trunking"
  page="mod-fail2ban"
  linkText="See hosted SIP">

On SignalWire's hosted platform your SIP traffic terminates at an edge operated to face the public Internet, and credential scanners are its problem. There is no registration log to watch and no jail to configure.
