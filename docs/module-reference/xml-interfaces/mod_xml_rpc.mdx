...
<SignalWireCallout
  title="The switch as a REST API"
  href="https://signalwire.com/docs/apis"
  page="mod-xml-rpc"
  linkText="See the REST APIs">

SignalWire exposes calls, messages, numbers, and configuration as REST resources with token auth and SDKs. The remote-command surface this module provides is the hosted platform's front door.
