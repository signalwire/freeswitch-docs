...
<SignalWireCallout
  title="Two dialects, one hosted engine"
  href="https://signalwire.com/docs/compatibility-api"
  page="mod-dialplan-asterisk"
  linkText="See the Compatibility API">

If your team routes calls in more than one dialect, SignalWire's hosted platform speaks two: SWML, a JSON/YAML call-control markup, and cXML, a Twilio-compatible markup. Both run on this same engine.
