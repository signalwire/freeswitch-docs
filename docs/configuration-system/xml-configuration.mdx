...
description: "How FreeSWITCH assembles its single XML configuration from many files: the preprocessor, include directives, variable syntax, and top-level sections."
