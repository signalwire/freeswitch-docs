...
sidebar_position: 3
id: module-loading
slug: /configuration/module-loading
title: "Chapter 5: Module Loading and Management"
description: "How FreeSWITCH selects modules to load at startup, the early and late load files, and how to load, unload, and reload modules from the console."
...
Most of these modules have a dedicated page in
[Part 9: Module Reference](/module-reference), which documents each one's
configuration file, the dialplan applications and API commands it registers, and
the channel variables it uses.
