...
<SignalWireCallout
  title="Variables, in a smaller namespace"
  href="https://signalwire.com/docs/swml/reference/calling/set"
  page="channel-variables"
  linkText="See set and variables in SWML">

Hosted SignalWire keeps per-call state in SWML, a JSON/YAML call-control markup: [`set`](https://signalwire.com/docs/swml/reference/calling/set) and [`unset`](https://signalwire.com/docs/swml/reference/calling/unset) manage document variables, and prompt and detection results arrive as named values. The catalog you handle shrinks from thousands of channel variables to the ones your document declares.
...
| `mod_com_amd` | `amd_status`, `amd_result`, `amd_wait_status`, `amd_wait_result`, `amd_execute_on_machine`, `amd_execute_on_person`, `amd_execute_on_unsure`, `amd_debug` | [mod_com_amd](/module-reference/applications/mod_com_amd) |
