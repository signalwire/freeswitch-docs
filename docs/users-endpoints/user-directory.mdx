...
- [Directory Structure and File Layout](#directory-structure-and-file-layout)
- [Domains](#domains)
  - [The Default Domain](#the-default-domain)
  - [Domain-Level Params and Variables](#domain-level-params-and-variables)
- [Defining a User](#defining-a-user)
  - [User Attributes](#user-attributes)
  - [User Params](#user-params)
  - [User Variables](#user-variables)
- [Parameter Reference](#parameter-reference)
  - [Common User Params](#common-user-params)
  - [Voicemail Params](#voicemail-params)
  - [Common User Variables](#common-user-variables)
- [Groups](#groups)
  - [Pointer Users](#pointer-users)
  - [Calling a Group](#calling-a-group)
- [Directory and SIP Authentication](#directory-and-sip-authentication)
- [Routing Inbound Calls with user\_context](#routing-inbound-calls-with-user_context)
- [Open-Ended Params and Variables](#open-ended-params-and-variables)
