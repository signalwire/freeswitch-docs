...
<SignalWireCallout
  title="Endpoints become resources"
  href="https://signalwire.com/docs/platform/getting-started"
  page="other-endpoints"
  linkText="See platform resources">

On hosted SignalWire, the things calls reach are resources you create by API: SIP endpoints, browser clients, AI agents, and phone numbers. New reach is an API call, not a new endpoint module.
