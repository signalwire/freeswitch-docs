...
<SignalWireCallout
  title="Profiles without the profile XML"
  href="https://signalwire.com/docs/platform/voice/sip/bring-your-own-carrier"
  page="sip-profiles"
  linkText="See hosted SIP and BYOC">

On hosted SignalWire, SIP endpoints, domains, and carrier peering are resources you create by API or dashboard. Registration, NAT handling, and TLS belong to the platform; bringing your own carrier stays supported.
