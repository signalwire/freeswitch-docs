...
<SignalWireCallout
  title="Browser calling without running the edge"
  href="https://signalwire.com/docs/browser-sdk"
  page="webrtc-verto"
  linkText="See the Browser SDK">

SignalWire's Browser SDK gives web pages calling and video on this same engine, with the TLS, WSS, and STUN/TURN edge operated for you. Tokens scope what each visitor can reach; there is no Verto endpoint to expose.
