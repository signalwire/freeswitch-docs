...
I have added this action to the default dialplan in the extension "Local_Extension" like this: (when extension 1010 gets called, a yac message will be send to a yac listener on 192.168.1.10)
