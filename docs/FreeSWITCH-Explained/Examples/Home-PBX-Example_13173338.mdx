...
For help constructing a regex pattern try [http://www.quanetic.com/regex.php](http://www.quanetic.com/regex.php) or any of the number of sites listed when you search google for "regex test".
