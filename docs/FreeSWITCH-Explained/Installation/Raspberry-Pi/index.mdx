...
# Raspberry Pi 
 ...
 Created by  John Boteler, last modified by  Andrey Volk on 2022.10.15
...
| I've created a bug indicating a few issues with the script. For the time being, I build from souce. ![(sorriso)](/images/icons/emoticons/smile.svg) ![](/images/icons/contenttypes/comment_16.png) Posted by jungleboogie at apr 28, 2016 15:51                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Cool, thanks. Ultimately the core dev team hopes to use their build system to create packages that do most of what is needed to get an RPi up and running quickly. ![](/images/icons/contenttypes/comment_16.png) Posted by boteman at mag 13, 2016 13:33                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
