...
# Virtualization Experiences 
 ...
 Created by  John Boteler, last modified on 2016.02.02
...
| Freeswitch in LXCCommented out the following in /lib/systemd/system/freeswitch.service#IOSchedulingClass=realtime #IOSchedulingPriority=2 #CPUSchedulingPolicy=rrand Freeswitch service is working fine. ![](/images/icons/contenttypes/comment_16.png) Posted by rlieback at ott 19, 2018 10:13 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
