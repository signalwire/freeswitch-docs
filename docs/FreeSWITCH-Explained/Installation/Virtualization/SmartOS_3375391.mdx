...
[http://www.perkin.org.uk/posts/automated-virtualbox-smartos-installs.html](http://www.perkin.org.uk/posts/automated-virtualbox-smartos-installs.html)

Instructions for installing in other ways (including under vmware) can be found here:  
[http://wiki.smartos.org/display/DOC/Getting+Started+with+SmartOS](http://wiki.smartos.org/display/DOC/Getting+Started+with+SmartOS)
...
[https://us-east.manta.joyent.com/Joyent%5FDev/public/SmartOS/latest.html](https://us-east.manta.joyent.com/Joyent%5FDev/public/SmartOS/latest.html)
...
[![](/images/placeholder-medium-code.png)freeswitch.xml](/attachments/3375391/17694857.xml)
