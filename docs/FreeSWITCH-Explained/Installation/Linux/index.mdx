...
Red Hat Enterprise linux, derived from Fedora, and CentOS can all use the same Makefile and init instructions shown on the [CentOS page](./CentOS-7-and-RHEL-7-for-FreeSWITCH-Enterprise_27590673.mdx#about).
