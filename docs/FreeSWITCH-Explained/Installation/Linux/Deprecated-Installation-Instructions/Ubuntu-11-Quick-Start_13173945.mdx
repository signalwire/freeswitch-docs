...
Ubuntu 11 is **deprecated**. Please use [Ubuntu 16 Xenial](./Ubuntu-16-Xenial_10683647.mdx)
...
Please also review the entries for Debian and Ubuntu under [https://freeswitch.org/confluence/display/FREESWITCH/Installation#Debian](https://freeswitch.org/confluence/display/FREESWITCH/Installation#Debian) for some more information before proceeding.
