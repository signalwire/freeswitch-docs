...
# CentOS 7 and RHEL 7 
 ...
 Created by  Sergey Safarov, last modified by  Andrey Volk on 2022.03.17
...
| As Mr. Vishnivetsky noted nearly 3 months ago, the http://files.[freeswitch.org](http://freeswitch.org/)/freeswitch-release-1-6.noarch.rpm package contains an error with regard to the 7Server/7server portion of the pathname breaks the installation. That seems like a pretty simple fix. Will it be done any time soon?ETA: I see that this issue first surfaced over a year ago: <http://lists.freeswitch.org/pipermail/freeswitch-users/2017-March/125216.html> ![](/images/icons/contenttypes/comment_16.png) Posted by DParker75243 at mag 29, 2018 15:17                                       |
| When compiling master on Centos 7, I had to yum install lksctp-tools-devel package and run ./configure again. ![](/images/icons/contenttypes/comment_16.png) Posted by verimor at lug 13, 2018 04:14                                                                                                                                                                                                                                                                                                                                                                                                     |
| error:/usr/local/src/freeswitch/libs/sofia-sip/libsofia-sip-ua/tporttport\_type\_sctp.c:206:10: error: variable 'initmsg' has initializer but incomplete type**change** **struct sctp\_initmsg initmsg = { 0 };**typedef struct { uint16\_t sinit\_num\_ostreams; uint16\_t sinit\_max\_instreams; uint16\_t sinit\_max\_attempts; uint16\_t sinit\_max\_init\_timeo; } sctp\_initmsg; #define SCTP\_INITMSG 2sctp\_initmsg initmsg = { 0 };reference：<http://blog.sina.com.cn/s/blog%5F539d6e0c0102zgvm.html> ![](/images/icons/contenttypes/comment_16.png) Posted by lixiao1016 at ott 27, 2018 19:56 |
| There is no RPM **db-devel** in CentOS 7, but there is **libdb-devel** \- _C development files for the Berkeley DB library_ ![](/images/icons/contenttypes/comment_16.png) Posted by kvishnivetsky at ott 29, 2018 17:01                                                                                                                                                                                                                                                                                                                                                                                 |
| There is no RPM **python26-devel**, but there are RPMs **python-devel** (v2.7.5) and **python36-devel**Wich should be used instead of **python26-devel**? ![](/images/icons/contenttypes/comment_16.png) Posted by kvishnivetsky at ott 29, 2018 17:06                                                                                                                                                                                                                                                                                                                                                   |
| **\--with-erlang** option will not be configured, or need to install erlang support (should be added to dependencies) ![](/images/icons/contenttypes/comment_16.png) Posted by kvishnivetsky at ott 29, 2018 17:14                                                                                                                                                                                                                                                                                                                                                                                       |
| RPM **lksctp-tools-devel** should be added to dependencied to buiild with **\--enable -stcp** ![](/images/icons/contenttypes/comment_16.png) Posted by kvishnivetsky at ott 29, 2018 17:24                                                                                                                                                                                                                                                                                                                                                                                                               |
