...
If you built FreeSWITCH™ from source code you should set file permissions and ownership before starting FreeSWITCH. Follow the [post-installation instructions](./Deprecated-Installation-Instructions/Debian-8-Jessie/Debian-Post-Install-Tasks_13172868.mdx#about).
