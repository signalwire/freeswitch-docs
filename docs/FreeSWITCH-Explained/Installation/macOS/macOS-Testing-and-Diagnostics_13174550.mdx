...
This page describes basic testing and diagnostics of FreeSWITCH™ on macOS. It is part of the FreeSWITCH™ [macOS](./index.mdx#about) documentation.  
\---
...
There is a limited [Troubleshooting Freeswitch](../../Troubleshooting-Debugging/Troubleshooting-Freeswitch.mdx#about) and [Troubleshooting Debugging](../../Troubleshooting-Debugging/index.mdx#about) information page available on the wiki. However, if you report a problem you will be asked for traces and log options. It will help to have them in advance if possible so you should become familiar with some of the following debugging commands:
