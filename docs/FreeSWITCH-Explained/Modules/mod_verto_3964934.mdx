...
# mod_verto 
 ...
 Created by  Brian West, last modified by  John Boteler on 2022.03.29
...
mod\_verto was introduced into the version 1.5 development branch of FreeSWITCH and is undergoing heavy development in the Master branch. Please see the [Community](../Community/index.mdx#irc) page for ways to participate in the development and testing of this neat protocol.
...
| Where can i find Javascript library and documentation for mod\_verto? ![](/images/icons/contenttypes/comment_16.png) Posted by at giu 16, 2014 15:47                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Very cool developers well done! ![](/images/icons/contenttypes/comment_16.png) Posted by at giu 19, 2014 21:56                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| https://stash.freeswitch.org/projects/FS/repos/freeswitch/browse/html5/verto ![](/images/icons/contenttypes/comment_16.png) Posted by antonio at lug 25, 2014 04:04                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| I'm trying to use the <https://myhostname.com/verto/demo> for checking a webrtc call from a Chrome browser on a mac. I have been able to log in and place a call from one extension to the other, however I do not see any voice path. After troubleshooting on my mac and the freeswitch server i noticed something different, On my mac there are multiple IP interfaces one with the IP address 172.26.x.x and another with the IP Address 10.65.x.x, the signaling is happening on the correct interface (10.65.x.x) but the chrome browser (chrome://webrtc-internals) establishes a RTCPeerConnections for both interfaces. What i further notice on the Freeswitch server is that it is trying to send the RTP stream to the 172.26.x.x address rather than the 10.64.x.x ip address.Is it possible to limit the RTCPeerConnection to only the 10.65.x.x address on my chrome browser, is this a configuration driven by the verto-min.js or something to be done on the chrome browser. Unfortunately I can't disable the 172.26.x.x IP Address on my mac laptop, this the wireless IP and the 10.65.x.x is the IP address assigned to my vpn client. ![](/images/icons/contenttypes/comment_16.png) Posted by h247v at set 29, 2015 17:02 |
| Found the answer to my question. I overlooked the basic ICE peer identification process. ![](/images/icons/contenttypes/comment_16.png) Posted by h247v at ott 01, 2015 20:18                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Verto Phone for Chrome browser - [step-by-step guide](http://kovalyshyn.pp.ua/1249.html) ![](/images/icons/contenttypes/comment_16.png) Posted by kovalyshyn at set 29, 2016 14:56                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [Verto is not just for call signaling](https://freeswitch.com/oss/verto-not-just-for-call-signaling/)The link had move. Where can I find this somewhere ? ![](/images/icons/contenttypes/comment_16.png) Posted by livem at mag 07, 2019 23:34                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
