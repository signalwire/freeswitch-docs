...
| Step 1 of "Compiling/Enabling" isn't very clear.Could it be changed to something likecd /usr/src/freeswitch/git clone <https://freeswitch.org/stash/scm/fs/freeswitch-contrib.git>cd freeswitch-contrib/ledr/c/mod\_odbc\_query ![](/images/icons/contenttypes/comment_16.png) Posted by werebear73 at mag 08, 2015 15:59 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Apparently this module stil does not accept the normalized odb-dsn syntax likepgsql://, etc.. it only accepts db:user:password syntax and uses the odbc driver...![(domanda)](/images/icons/emoticons/help_16.svg) ![](/images/icons/contenttypes/comment_16.png) Posted by madovsky at ott 03, 2019 13:45                 |
