...
This module provides expression evaluation so that you can do math inside any context where module code can be invoked. The most likely place you will use this is in the [dialplan](../Dialplan/index.mdx#about). 
