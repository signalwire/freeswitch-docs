...
You’ll have to generate mono.lib for your compiler. Details here: [http://www.mono-project.com/Embedding%5FMono](http://www.mono-project.com/Embedding%5FMono) (Search for mono.def). A batch file is provided: monolibx86.cmd:
