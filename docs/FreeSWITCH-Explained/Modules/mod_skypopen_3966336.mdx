...
* 1 [mod\_skypopen does not work anymore](#mod_skypopen-does-not-work-anymore)
* 2 [SHORT BLUEPRINT: STEPS NEEDED TO USE SKYPOPEN](#short-blueprint-steps-needed-to-use-skypopen-)
* 3 [Overview and Info](#-overview-and-info-)  
   * 3.1 [What is Skypopen](#what-is-skypopen-)  
   * 3.2 [Which Skype Client to use on Linux](#-which-skype-client-to-use-on-linux)  
   * 3.3 [Supported Platforms and Distros](#-supported-platforms-and-distros)  
   * 3.4 [Skype Contacts, Messages, Buddy List, etc](#-skype-contacts-messages-buddy-list-etc-)
* 4 [Building, Configuration and Operation](#-building-configuration-and-operation)  
   * 4.1 [Linux](#-skypopen-)  
      * 4.1.1 [Which packages are required to build mod\_skypopen on Linux](#-which-packages-are-required-to-build-mod_skypopen-on-linux-)  
         * 4.1.2 [Build procedure (all Linuxes) for FS and mod\_skypopen](#-build-procedure-all-linuxes-for-fs-and-mod_skypopen-)  
         * 4.1.3 [Pulseaudio Configuration](#-pulseaudio-configuration-)  
         * 4.1.4 [Interactive Skype Client INSTALLER and CONFIGURATOR](#-interactive-skype-client-installer-and-configurator-)  
         * 4.1.5 [How to start the Skype clients, then start FreeSWITCH and load mod\_skypopen on Linux](#-how-to-start-the-skype-clients-then-start-freeswitch-and-load-mod_skypopen-on-linux-)  
         * 4.1.6 [Problems in starting skype clients ?](#-problems-in-starting-skype-clients--)  
   * 4.2 [Windows](#-skypopen-)  
      * 4.2.1 [How to build Skypopen on Windows, and which tools and files are needed](#-how-to-build-skypopen-on-windows-and-which-tools-and-files-are-needed-)  
         * 4.2.2 [Config files location and script to start Skype client instances on Windows](#-config-files-location-and-script-to-start-skype-client-instances-on-windows-)  
         * 4.2.3 [Running Skypopen on Windows as a Service](#-running-skypopen-on-windows-as-a-service-)
* 5 [Config File Details (skypopen.conf.xml)](#-config-file-details-skypopenconfxml-)
* 6 [Dialplan, and how to use Skypopen](#-dialplan-and-how-to-use-skypopen-)  
   * 6.1 [Dialplan](#-skypopen-)  
   * 6.2 [The "RR" interface, poor man interface grouping](#-the-rr-interface-poor-man-interface-grouping-)  
   * 6.3 [optional "Skype URI"](#-optional-skype-uri-)
* 7 [API and CLI Commands](#-api-and-cli-commands-)  
   * 7.1 [sk](#-skypopen-)  
...
* 9 [Events](#-skypopen-)  
   * 9.1 [Voice Calls](#-skypopen-)  
   * 9.2 [MESSAGE (Chat)](#-skypopen_chat-)
* 10 [Adding and removing interfaces on the fly](#-adding-and-removing-interfaces-on-the-fly-)
* 11 [Advanced Configuration](#-advanced-configuration-)  
   * 11.1 [Multiple concurrent incoming calls to the same Skype username](#-multiple-concurrent-incoming-calls-to-the-same-skype-username-)  
   * 11.2 [Running multiple instances (MAX 6) of the same Skype username on Linux, for BOTH incoming and outbound calls](#-running-multiple-instances-max-6-of-the-same-skype-username-on-linux-for-both-incoming-and-outbound-calls-)
* 12 [Testing with the "Echo" application](#-testing-with-the-echo-application-)
* 13 [TO DO](#-skypopen-)
* 14 [TROUBLESHOOTING](#troubleshooting-)  
   * 14.1 [Problems in starting skype clients ?](#-problems-in-starting-skype-clients--)  
   * 14.2 [Error and warnings at the starting of Skype clients on Linux](#error-and-warnings-at-the-starting-of-skype-clients-on-linux-)
* 15 [Use cases, integration, special implementations](#-use-cases-integration-special-implementations-)  
   * 15.1 [Skypopen Directory-dialing example](#mod_skypopen-does-not-work-anymore)  
   * 15.2 [Passing Caller ID to Remote Skype ID - by Zohair](#passing-caller-id-to-remote-skype-id---by-zohair-)
* 16 [How To Report BUGS and Feature Requests](#how-to-report-bugs-and-feature-requests-)
...
If the bug reports crashes, core dumps, etc, please first read this guide: [Reporting Issues to GitHub](../Troubleshooting-Debugging/Reporting-Issues-to-GitHub.mdx#about) then file a Jira with all relevant info to mod\_skypopen.
