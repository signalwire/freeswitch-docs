...
This UML diagram depicts processing of audio frames by each of detection threads running in AVMD session, after thread is signaled to start processing by the AVMD main thread in avmd\_process function.![](/download/temp/plantuml12330104379316349158.png)  
