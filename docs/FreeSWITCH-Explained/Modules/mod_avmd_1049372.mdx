...
This UML diagram depicts processing of audio frames by each of detection threads running in AVMD session, after thread is signaled to start processing by the AVMD main thread in avmd\_process function.![](/download/temp/plantuml14487888360518277528.png)  
