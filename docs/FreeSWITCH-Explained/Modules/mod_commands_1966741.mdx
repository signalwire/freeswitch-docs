...
[mod\_commands](./mod_commands_1966741.mdx) processes the [FreeSWITCH API commands](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-).
...
An [API command](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) can be called from the dialplan. Example:
...
[API commands](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) with multiple arguments usually have the arguments separated by a space:
...
Execute an [API command](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) in a thread.
...
| bgapi    | Execute an [API command](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) in a thread.                                                                                                                                                                        | bgapi \<command>\[ \<command\_args>\]                                                         |                                                                                                                                                                                                                               |
...
Execute an [API command](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) with variable expansion.
...
Toggles API expansion. With it off, no [API functions](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) can be expanded inside channel variables like $\{show channels} This is a specific security mode that is not often used.
...
Show help for all the [API commands](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-).
...
* api – list [API commands](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) exposed by loadable modules
...
Wrap another [API command](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) in XML.
...
Schedule an [API call](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) in the future.
...
Unschedule a previously scheduled [API command](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-).
