...
# mod_commands 
 ...
 Created by  John Boteler, last modified by  Henning Heedfeld on 2022.10.21
...
* [1\. Usage](#command-2)  
   * [1.1 CLI](#command-2)  
   * [1.2 API/Event Interfaces](#12-apievent-interfaces-)  
   * [1.3 Scripting Interfaces](#13-scripting-interfaces-)  
   * [1.4 From the Dialplan](#command-2)
* [2\. Format of returned data](#2-format-of-returned-data)
* [3\. Core Commands](#3-core-commands)  
   * [3.1 acl](#command-2)  
         * [3.1.1 Syntax](#311-syntax)  
         * [3.1.2 Examples](#312-examples)  
   * [3.2 alias](#command-2)  
         * [3.2.1 Syntax](#311-syntax)  
         * [3.2.2 Examples](#312-examples)  
   * [3.3 bgapi](#command-2)  
         * [3.3.1 Syntax](#311-syntax)  
         * [3.3.2 Examples](#312-examples)
* [cond](#command-2)
...
* [reloadxml](#reloadxml)
* [show](#command-2)  
   * [Tips For Showing Calls and Channels](#tips-for-showing-calls-and-channels-)
* [shutdown](#shutdown)
* [status](#command-2)
...
* [xml\_wrap](#command-2)
* [Call Management Commands](#call-management-commands)  
* [break](#command-2)  
...
* [Record/Playback Commands](#recordplayback-commands)  
...
[mod\_commands](./mod_commands_1966741.mdx#--) processes the [FreeSWITCH API commands](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-).
...
* the [event socket interface](../Introduction/Glossary_13173966.mdx#event-socket), and
...
An [API command](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) can be called from the dialplan. Example:
...
[API commands](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) with multiple arguments usually have the arguments separated by a space:
...
**Extraction Perl Script** Espandi fonte 
...
Match an IP address against an [access control list (ACL)](../Networking/3965687.mdx#-acl-).
...
Provide an alternative name (i.e., an alias) to commonly used commands on the [CLI](../Client-and-Developer-Interfaces/1048948.mdx#or) to save on some keystrokes.
...
Execute an [API command](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) in a thread.
...
| -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| acl      | Match an IP address against an [access control list (ACL)](../Networking/3965687.mdx#-acl-).                                                                                                                                                                    | acl &lt;ip\_address> &lt;acl\_name>                                                               | acl 1.2.3.4 test                                                                                                                                                                                                              |
...
| bgapi    | Execute an [API command](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) in a thread.                                                                                                                                                                        | bgapi &lt;command>\[ &lt;command\_args>\]                                                         |                                                                                                                                                                                                                               |
...
Execute an [API command](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) with variable expansion.
...
Toggles API expansion. With it off, no [API functions](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) can be expanded inside channel variables like ${show channels} This is a specific security mode that is not often used.
...
Show help for all the [API commands](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-).
...
* api – list [API commands](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) exposed by loadable modules
...
Wrap another [API command](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) in XML.
...
| **unmask** | Stop the masking and continue recording live audio normally.See <http://jira.freeswitch.org/browse/FS-5269>                                                                                                                                                                                                                                                                         |
...
Schedule an [API call](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) in the future.
...
See also <https://freeswitch.org/confluence/display/FREESWITCH/mod%5Fdptools%3A+tone%5Fdetect>

## unsched_api

Unschedule a previously scheduled [API command](../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-).
...
| SWITCH\_ADD\_API(commands\_api\_interface, "json", "JSON API", json\_function, "JSON"); I found **json** api in mod\_commands.c, but I do not know the usage.Any example?Thanks. ![](/images/icons/contenttypes/comment_16.png) Posted by livem at gen 17, 2017 07:09                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
