...
Im not going to explain how to install and configure SNMP daemon as there is plenty of reference on the internet regarding this topic. One of them is here([http://www.it-slav.net/blogs/2008/11/11/install-and-configure-snmp-on-rhel-or-centos/](http://www.it-slav.net/blogs/2008/11/11/install-and-configure-snmp-on-rhel-or-centos/)) so have a look.
