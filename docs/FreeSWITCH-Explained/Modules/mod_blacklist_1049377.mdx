...
# mod_blacklist 
 ...
 Created by  John Boteler, last modified on 2014.06.17
...
**Adding to Blacklist** Espandi fonte 
...
**Checking the Blacklist** Espandi fonte 
...
**Delete Blacklist Item** Espandi fonte 
...
**Blacklist Inbound Call By CallerID** Espandi fonte 
...
| I'm a "edit while reading" wiki user type, please allow me to edit things like the reference to monkeys.wav away ![](/images/icons/contenttypes/comment_16.png) Posted by yellow at mag 25, 2016 16:29 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
