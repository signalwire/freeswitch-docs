...
This module, just as [mod\_event\_socket](./mod_event_socket_1048924#11-acl), operates in two modes, **inbound** and **outbound**.

ESL modes of operation

See [mod\_event\_socket](./mod_event_socket_1048924#11-acl) for a more detailed description on inbound and outbound modes.
...
To install Erlang, please go to [https://www.erlang.org/downloads](https://www.erlang.org/downloads). All source files can be downloaded there, and each release has instructions for popular platforms and package managers.
...
| apply-inbound-acl       | Just as with [mod\_event\_socket](./mod_event_socket_1048924#11-acl), provide additional restrictions via [Access Control List (ACL)](../Networking/3965687.mdx)s besides the cookie .                                                                                                                                                                                                                                                                                           | valid [ACL](../Networking/3965687.mdx) name | \<param name="apply-inbound-acl" value="lan"/> |
...
[https://github.com/signalwire/freeswitch/blob/66aa064588e66fed1aa7488ba8f363939b157e51/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/handle%5Fmsg.c#L1049](https://github.com/signalwire/freeswitch/blob/66aa064588e66fed1aa7488ba8f363939b157e51/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/handle%5Fmsg.c#L1049)
...
QUESTION: [mod\_event\_socket](./mod_event_socket_1048924#11-acl) has `execute` to run dialplan applications, but didn't see that documented here, nor in the source. Does that mean [mod\_erlang\_event](./mod_erlang_event_1048926.mdx#api) does not support this?
...
[https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/mod%5Ferlang%5Fevent.c#L646](https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/mod%5Ferlang%5Fevent.c#L646)

`{call\_event, Data}`

[https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/mod%5Ferlang%5Fevent.c#L739](https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/mod%5Ferlang%5Fevent.c#L739)

[https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/mod%5Ferlang%5Fevent.c#L779](https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/mod%5Ferlang%5Fevent.c#L779)

`{get\_pid}`

See the part also below when invoking \`mod\_erlang\_event\` with \`myhandler:!\`.

[https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/mod%5Ferlang%5Fevent.c#L1548](https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/mod%5Ferlang%5Fevent.c#L1548)

Based on the examples, I'm also not sure what the syntax of \`event\` tuples should be, but the source to figure it out:

[https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/freeswitch.erl#L348](https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/freeswitch.erl#L348)

[https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/freeswitch.erl#L165](https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/freeswitch.erl#L165)

[https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/freeswitch.erl#L26](https://github.com/signalwire/freeswitch/blob/718d2341f7327feea52c840648e42b33eb9c69dd/src/mod/event%5Fhandlers/mod%5Ferlang%5Fevent/freeswitch.erl#L26)
...
* [https://learnyousomeerlang.com/distribunomicon](https://learnyousomeerlang.com/distribunomicon)
* [http://erlang.org/doc/man/epmd.html](http://erlang.org/doc/man/epmd.html)
* [https://stackoverflow.com/questions/51740621/connecting-to-production-node-when-short-name-is-set](https://stackoverflow.com/questions/51740621/connecting-to-production-node-when-short-name-is-set)
* [https://stackoverflow.com/questions/26474591/connecting-erlang-nodes-when-an-internal-and-external-ip-address-are-at-play](https://stackoverflow.com/questions/26474591/connecting-erlang-nodes-when-an-internal-and-external-ip-address-are-at-play)
...
#### 6.1.3\. Using [Event Socket Library](../Client-and-Developer-Interfaces/Event-Socket-Library/index.mdx) (ESL) commands
...
[Event Socket Library](../Client-and-Developer-Interfaces/Event-Socket-Library/index.mdx)'s `api` command allows sending [FreeSWITCH API](../Introduction/FreeSWITCH-API.mdx) commands to FreeSWITCH. We'll send the `status` command (note how the connection is negotiated automagically), and the FreeSWITCH [C node](http://erlang.org/doc/tutorial/cnode.html) will send the reply back to us asynchronously (all Erlang messages are asynchronous), so we have to explicitly receive it:
...
We'll now issue the `status` [FreeSWITCH API](../Introduction/FreeSWITCH-API.mdx) commands in the background using `bgapi`:
...
2. In addition to a directed reply, a normal `BACKGROUND_JOB` event (see [Event List](../Introduction/Event-System/Event-List_7143557.mdx#nat)) is also fired whenever a [FreeSWITCH API](../Introduction/FreeSWITCH-API.mdx) command is executed in the background, which you could alternately choose to receive. (See `events` in the "API" section below on how to subscribe to FreeSWITCH system events).

api vs bgapi

A [FreeSWITCH API](../Introduction/FreeSWITCH-API.mdx) commands called with `bgapi`
...
See [Event Socket Library](../Client-and-Developer-Interfaces/Event-Socket-Library/index.mdx)'s "`bgapi`" section to see how to set custom a `Job-UUID` .
...
See section **6\. Inbound mode** on how to set up a distributed Erlang node, and how to use the [Event Socket Library](../Client-and-Developer-Interfaces/Event-Socket-Library/index.mdx) commands.
...
The api is very similar to the one in [mod\_event\_socket](./mod_event_socket_1048924#11-acl), just expressed in Erlang terms. You can send any of these terms by using the ! operator as above.

#### api

Send a [FreeSWITCH API](../Introduction/FreeSWITCH-API.mdx) command, a **blocking** call.
...
Subscribe to an event. See [mod\_event\_](./mod_event_socket_1048924#11-acl)[socket](./mod_event_socket_1048924#11-acl) for more.
...
* `SendmsgCommandHeaders` is a list of key/value tuples specifying `sendmsg` commands (see section **3.9 `sendmsg`** in [mod\_event\_socket](./mod_event_socket_1048924#11-acl) ).
...
| Probably it is worth to add a reference to Erlang library here: [https://github.com/jamhed/fswitch](https://github.com/jamhed/fswitch) ![](/images/icons/contenttypes/comment_16.png) Posted by jamhed at Aug 21, 2017 17:53 |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
