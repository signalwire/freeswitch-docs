...
| apply-inbound-acl       | Just as with [mod\_event\_socket](./mod_event_socket_1048924#11-acl), provide additional restrictions via [Access Control List (ACL)](../Networking/3965687.mdx#-acl-)s besides the cookie .                                                                                                                                                                                                                                                                                           | valid [ACL](../Networking/3965687.mdx#-acl-) name | \<param name="apply-inbound-acl" value="lan"/> |
...
We'll now issue the `status` [FreeSWITCH API](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) commands in the background using `bgapi`:
...
A [FreeSWITCH API](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) commands called with `bgapi` 
...
Send a [FreeSWITCH API](../Introduction/FreeSWITCH-API.mdx#-freeswitch--freeswitch-api-) command, a **blocking** call.
