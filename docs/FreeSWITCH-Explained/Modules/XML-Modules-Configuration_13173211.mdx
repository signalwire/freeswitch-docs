...
# XML Modules Configuration 
 ...
 Created by  Italo Monteiro, last modified by  Attila Gulyas on 2019.12.23
...
modules.conf.xml is a configuration entity that exists in the "configuration" section of [freeswitch.xml](../Bit-Bucket/For-Consideration/FreeSWITCH.xml_13173070.mdx#default-configuration-file). It denotes which modules to load, and in what order.
