...
# mod_skinny 
 ...
 Created by  John Boteler, last modified by  Branden Jordan on 2018.10.09
...
* Softkeys/Stimulus:  
   * **CFwdAll/ForwardAll, CFwdBusy/ForwardBusy, CFwdNoAnswer/ForwardNoAnswer**; see [FS-3048](https://freeswitch.org/jira/browse/FS-3048?src=confmacro)  \-[Autentica](https://freeswitch.org/confluence/plugins/servlet/applinks/oauth/login-dance/authorize?applicationLinkID=c4b15fa3-ad57-3c05-af05-8c167cb92266) per visualizzare i dettagli del problema  
   * /AutoAnswer, /AutoAnswerRelease  
   * /ServiceURL  
   * /Conference, /MeetMeConference, Join, MeetMeConfrn  
   * Park/CallPark, CallPickUp/CallPickup, GrpCallPickUp/GroupCallPickup; see [FS-5662](https://freeswitch.org/jira/browse/FS-5662?src=confmacro)  \-[Autentica](https://freeswitch.org/confluence/plugins/servlet/applinks/oauth/login-dance/authorize?applicationLinkID=c4b15fa3-ad57-3c05-af05-8c167cb92266) per visualizzare i dettagli del problema  
   * Info  
   * Confrn  
   * DND (DoNotDisturb); see [FS-3047](https://freeswitch.org/jira/browse/FS-3047?src=confmacro)  \-[Autentica](https://freeswitch.org/confluence/plugins/servlet/applinks/oauth/login-dance/authorize?applicationLinkID=c4b15fa3-ad57-3c05-af05-8c167cb92266) per visualizzare i dettagli del problema
* Per line:  
   * no-answer-duration  
   * Ring policies: on-idle, on-active (when any line on the phone has a call in progress); see [FS-5384](https://freeswitch.org/jira/browse/FS-5384?src=confmacro)  \-[Autentica](https://freeswitch.org/confluence/plugins/servlet/applinks/oauth/login-dance/authorize?applicationLinkID=c4b15fa3-ad57-3c05-af05-8c167cb92266) per visualizzare i dettagli del problema  
...
* Features:  
   ...
   * **[Codec Negotiation](http://wiki.freeswitch.org/wiki/Codec%5FNegotiation "Codec Negotiation")** (help needed, see [FS-5460](https://freeswitch.org/jira/browse/FS-5460?src=confmacro)  \-[Autentica](https://freeswitch.org/confluence/plugins/servlet/applinks/oauth/login-dance/authorize?applicationLinkID=c4b15fa3-ad57-3c05-af05-8c167cb92266) per visualizzare i dettagli del problema  
...
**XMLDefault.cnf.xml** Espandi fonte 
...
**SEP001120AABBCC.cnf.xml (minimal)** Espandi fonte 
...
**SEP001120AABBCC.cnf.xml (extended)** Espandi fonte 
...
**conf/skinny\_profiles/internal.xml** Espandi fonte 
...
**conf/directory/default/skinny-example.xml** Espandi fonte 
...
Please test on your SCPP/Skinny system and tell us how to improve this module at [FS-477](https://freeswitch.org/jira/browse/FS-477?src=confmacro)  \-[Autentica](https://freeswitch.org/confluence/plugins/servlet/applinks/oauth/login-dance/authorize?applicationLinkID=c4b15fa3-ad57-3c05-af05-8c167cb92266) per visualizzare i dettagli del problema 
