...
* 3 [Setting up the Pizza Demo](#-freeswitch--mod_pocketsphinx)
* 4 [Other info](#-freeswitch--mod_pocketsphinx)
* 5 [Acoustic Model for german language](#-freeswitch--mod_pocketsphinx)  
   * 5.1 [Requirements](#requirements)  
   * 5.2 [Process](#-freeswitch--mod_pocketsphinx)
* 6 [See Also](#-freeswitch--mod_pocketsphinx)
