...
Seems to be an identical version of [mod\_pocketsphinx](./mod_pocketsphinx_13173540.mdx), which is has been updated more recently, and its edit history suggests being the original.
