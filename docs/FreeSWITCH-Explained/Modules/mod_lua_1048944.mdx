...
| Freeswitch on Debian currently depends on libodbc and unixodbc. We have found both of these versions very unstable in high call volume environments. Upgrading to MySQL ODBC driver 5.3.4 with unixODBC 2.3.1 has really improved our stability and we have not seen any crashes since the full rebuild of the environment. ![](/images/icons/contenttypes/comment_16.png) Posted by russell at ott 02, 2014 21:39 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| From what I'm reading about LUA, arguments passed from the dialplan into the LUA script will be available as arg\[1\], arg\[2\], etc, not argv\[n\] as stated above. ![](/images/icons/contenttypes/comment_16.png) Posted by tom@tomlynn.com at dic 18, 2014 13:28                                                                                                                                                |
...
| John, as it turns out, I'd been having trouble getting arguments to work at all. Today I see that argv does in fact work. I'd been looking at LUA documentation that seemed to contradict this, though. Thanks. ![](/images/icons/contenttypes/comment_16.png) Posted by tom@tomlynn.com at gen 25, 2015 16:11                                                                                                     |
