...
# mod_xml_curl 
 ...
 Created by  John Boteler, last modified by  Henning Heedfeld on 2022.06.24
...
If it receives a valid response from your web application, then it will load the configuration just like it would if you had put it into the [FreeSWITCH Configuration File](../Bit-Bucket/For-Consideration/FreeSWITCH.xml_13173070.mdx#default-configuration-file). If it receives an invalid or 404 _not found_ response, then it will attempt to look for the file on disk instead.
...
* 1 [Click to expand Table of Contents](#xml-usage)
* 2 [Considerations](#considerations-)
* 3 [Installation](#-installation-)
* 4 [Configuration](#-configuration-)  
   * 4.1 [&lt;binding> options](#-binding-options-)
* 5 [API tips and tricks](#-api-tips-and-tricks-)  
   * 5.1 [Pre-processor directives and variables](#-pre-processor-directives-and-variables-)
* 6 [API Request Fields](#-api-request-fields-)  
   * 6.1 [Event variables](#event-variables)  
   * 6.2 [Channel variables](#channel-variables)  
   * 6.3 [Section: configuration](#-section-configuration-)  
   * 6.4 [Section: directory](#-section-directory-)  
   * 6.5 [Section: Dialplan](#-section-dialplan-)
* 7 [XML Usage](#xml-usage)  
   * 7.1 [Section: dialplan](#-section-dialplan-)  
   * 7.2 [Section: configuration](#-section-configuration-)  
   * 7.3 [Section: directory](#-section-directory-)  
   * 7.4 [Section: not found](#-section-not-found-)  
   * 7.5 [post\_load configuration](#-post_load-configuration-)
* 8 [Caching](#caching)
* 9 [Alternative ways of storing static configurations](#-alternative-ways-of-storing-static-configurations-)
* 10 [Client implementations](#-client-implementations-)  
   * 10.1 [PHP](#php)  
   * 10.2 [Other languages](#other-languages)  
   * 10.3 [Lua](#xml-usage)
...
Then edit your [Modules XML Configuration File](./XML-Modules-Configuration_13173211.mdx#xml-modules-configuration) inside your FreeSWITCH configuration directory, and place the following at the top of the file;
