...
To call a Python application from dialplan, you should probably be familiar with the [Dialplan](../Dialplan/index.mdx#about). You simply call it as an application similar to:
