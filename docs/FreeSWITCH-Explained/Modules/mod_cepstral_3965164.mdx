...
# mod_cepstral 
 ...
 Created by  Belaid Areski, last modified by  John Boteler on 2016.05.17
...
| Version 6.x.x of Cepstral works again ![](/images/icons/contenttypes/comment_16.png) Posted by madovsky at mag 17, 2016 09:35 |
| ---------------------------------------------------------------------------------------------------------------------------- |
