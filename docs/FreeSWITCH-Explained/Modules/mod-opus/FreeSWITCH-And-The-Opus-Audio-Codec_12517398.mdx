...
# FreeSWITCH And The Opus Audio Codec 
 ...
 Created by  Giacomo Vacca, last modified on 2017.08.11
...
* 1 [Introduction](#-freeswitch--freeswitch-and-the-opus-audio-codec-)
* 2 [Using Opus in FreeSWITCH](#using-opus-in-freeswitch)  
   * 2.1 [Examples](#-freeswitch--freeswitch-and-the-opus-audio-codec-)
* 3 [User Manual](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 3.1 [Configuration Parameters](#configuration-parameters)
* 4 [Examples of configuration](#examples-of-configuration)  
   * 4.1 [WebRTC configuration](#webrtc-configuration)  
   * 4.2 [Transcoding only configuration](#webrtc-configuration)
* 5 [SDP Offer/Answer for Opus streams](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 5.1 [Mandatory parameters](#mandatory-parameters)  
   * 5.2 [Optional parameters](#optional-parameters)  
      * 5.2.1 [Decoder parameters](#decoder-parameters)  
         * 5.2.2 [Encoder parameters](#decoder-parameters)  
   * 5.3 [SDP offers examples](#sdp-offers-examples)  
      * 5.3.1 [Generic offer](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 5.4 [Narrowband offer](#narrowband-offer)
* 6 [Development](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 6.1 [FEC on the decoder](#fec-on-the-decoder)  
   * 6.2 [FEC on the encoder](#fec-on-the-encoder)  
   * 6.3 [Codec Control (Congestion control)](#codec-control-congestion-control)
* 7 [Debugging](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 7.1 [Introduction](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 7.2 [How to work with the "opus\_debug" CLI command](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
      * 7.2.1 [Example](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
         * 7.2.2 [Example with PLC](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
         * 7.2.3 [Example with FEC](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 7.3 [Statistics of Decoder](#statistics-of-decoder)  
   * 7.4 [Statistics of Encoder](#statistics-of-decoder)  
   * 7.5 [Debugging with Wireshark](#debugging-with-wireshark)
* 8 [APPENDIX – libopus](#appendix--libopus)  
   * 8.1 [Installing libopus](#installing-libopus)  
   * 8.2 [Building libopus](#building-libopus)  
      * 8.2.1 [Prepare source from tarball](#prepare-source-from-tarball)  
         * 8.2.2 [Prepare source from git](#prepare-source-from-git)  
         * 8.2.3 [Build](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 8.3 [Packaging libopus](#packaging-libopus)  
      * 8.3.1 [Building libopus RPMs](#building-libopus-rpms)
* 9 [APPENDIX – Building mod\_opus](#appendix--building-mod_opus)
* 10 [Glossary](#-freeswitch--freeswitch-and-the-opus-audio-codec-)
* 11 [References](#-freeswitch--freeswitch-and-the-opus-audio-codec-)  
   * 11.1 [Dragos presentation at ClueCon 2017](#dragos-presentation-at-cluecon-2017)
* 12 [Recommended reads](#recommended-reads)
