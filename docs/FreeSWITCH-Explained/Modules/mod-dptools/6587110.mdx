...
The following example, once added to your [dialplan](../../Dialplan/index.mdx#about), will accept a call on extension 666, enable recording for the session, and bridge the call to the toll-free PSTN number through a VoIP provider. Under default FreeSWITCH installations, recordings through the extension below will be saved to `/usr/local/freeswitch/recordings/`
