...
# mod_dptools: sched hangup 
 ...
 Created by  Maximiliano Guerra de Medeiros, last modified by  John Boteler on 2021.03.25
...
### 2.3 Using the [FreeSWITCH API](../../Introduction/FreeSWITCH-API_30867723.mdx#-freeswitch--freeswitch-api-) outside the dialplan
