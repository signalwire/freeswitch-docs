...
# mod_dptools: play_and_get_digits 
 ...
 Created by  Maximiliano Guerra de Medeiros, last modified by  livem Chan on 2019.05.30
...
| Invalid responses are recorded to (var\_name)\_invalid as of commit[fb173c9af7e](https://freeswitch.org/stash/projects/FS/repos/freeswitch/commits/fb173c9af7e54b06688e1cc7d3bfd6b48aa8bb43). ![](/images/icons/contenttypes/comment_16.png) Posted by bjordan at gen 10, 2016 00:26 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Added. Please check if I got it correct.Thanks. ![](/images/icons/contenttypes/comment_16.png) Posted by boteman at gen 13, 2016 16:49                                                                                                                                               |
| Yup that looks good thanks! ![](/images/icons/contenttypes/comment_16.png) Posted by bjordan at feb 01, 2016 19:54                                                                                                                                                                   |
| session:playAndGetDigits(1, 1, 3, 3000, "#", "speak:'" .. tts .. "'", "", "12\*") How can I use **speak** in **playAndGetDigits** in **lua** script ? ![](/images/icons/contenttypes/comment_16.png) Posted by livem at gen 05, 2017 02:07                                           |
| I do not think that you can use speak there. That app plays sound files, but 'speak' is another application to run. Maybe ask on the mailing list or HipChat? ![](/images/icons/contenttypes/comment_16.png) Posted by boteman at gen 07, 2017 00:16                                 |
| Thank you. ![](/images/icons/contenttypes/comment_16.png) Posted by livem at gen 10, 2017 02:23                                                                                                                                                                                      |
