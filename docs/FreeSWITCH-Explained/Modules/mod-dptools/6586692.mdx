...
* the latter are applications that can be used in [dialplan](../../Dialplan/index.mdx#about)s, [event socket applications](../../Introduction/Glossary.mdx#event-socket), etc.
