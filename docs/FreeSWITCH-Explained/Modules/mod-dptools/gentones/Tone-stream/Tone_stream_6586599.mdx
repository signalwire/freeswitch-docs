...
Outside of [mod\_dptools: gentones](../../6586546.mdx#about), `tone_stream` is also used with [TTML](./TTML_27591313.mdx#usage) files (see [Freeswitch for new people](../../../../Miscellaneous/Freeswitch-for-new-people_13173027.mdx#about) and [XML Dialplan](../../../../Dialplan/XML-Dialplan/index.mdx#about)).
