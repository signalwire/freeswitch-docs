...
# Silence Stream 
 ...
 Created by  Italo Rossi on 2015.05.08

## Silence stream

Silence\_stream is a file format that may be used anywhere that a file is expected. Silence\_stream is implemented by [mod\_tone\_stream](./Tone_stream_6586599.mdx#about).

Click here to expand Table of Contents

* 1 [Silence stream](#silence-stream)
* 2 [Usage](#silence-stream)  
   * 2.1 [Examples](#silence-stream)
