...
# mod_dptools: detect_silence 
 ...
 Created by  Brian Hughes, last modified by  John Boteler on 2021.10.12
...
* 1 [Usage](#-freeswitch--mod_dptools-detect_silence-)
...
```xml
<action application="wait_for_silence" data="200 15 5000"/>
```
