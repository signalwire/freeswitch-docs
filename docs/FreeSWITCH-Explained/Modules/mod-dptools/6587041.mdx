...
Use the console command `show file` to display available formats in [fs\_cli](../../Client-and-Developer-Interfaces/1048948.mdx) or type `fs_cli -x 'show file'` in the terminal of your operating system.
...
* [record\_waste\_resources](../../../Channel-Variables-Catalog/record_waste_resources_16352905.mdx)
* [record\_sample\_rate](../../../Channel-Variables-Catalog/record_sample_rate_16353888.mdx)
* [RECORD\_WRITE\_ONLY](../../../Channel-Variables-Catalog/RECORD_WRITE_ONLY_16354620.mdx)
...
* [record\_samples](../../../Channel-Variables-Catalog/record_samples_39419915.mdx)
* [record\_ms](../../../Channel-Variables-Catalog/record_ms_16353885.mdx)
