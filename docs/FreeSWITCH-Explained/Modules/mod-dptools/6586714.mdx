...
Play while doing speech recognition. Result is stored in the \[\[Variable\_detect\_speech\_result | [detect\_speech\_result](../../../Channel-Variables-Catalog/detect_speech_result_16352994.mdx)\]\] channel variable.
...
* [detect\_speech\_result](../../../Channel-Variables-Catalog/detect_speech_result_16352994.mdx) — FreeSWITCH sets this variable to the reason that terminated the playback or TTS. Returns "`DIGIT: x`" where x = the Touch Tone digit that terminated the playback or TTS sequence.
