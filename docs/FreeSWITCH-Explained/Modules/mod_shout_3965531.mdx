...
From the [CLI](../Client-and-Developer-Interfaces/1048948.mdx), run `load mod_shout`
...
```
3. Set your [hold\_music variable](../../Channel-Variables-Catalog/hold_music_16352624.mdx) to point to the local stream that you just created.
