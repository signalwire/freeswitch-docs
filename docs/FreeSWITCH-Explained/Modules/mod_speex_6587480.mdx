...
# mod_speex 
 ...
 Created by  John Boteler, last modified by  Jim Lynch on 2018.05.13
...
* 1 [Codec negotiation](#codec-negotiation)
* 2 [Configuration](#configuration)  
   * 2.1 [Example default configuration](#example-default-configuration-)
* 3 [See Also](#see-also)
