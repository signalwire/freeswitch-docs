...
# mod_callcenter 
 ...
 Created by  John Boteler, last modified by  Chad Phillips on 2022.05.31
...
* 1 [Configuration](#-callcenter_config-)  
   * 1.1 [Settings](#-settings-)  
         * 1.1.1 [odbc-dsn](#-odbc-dsn-)  
         * 1.1.2 [dbname](#-dbname-)  
   * 1.2 [Agent options](#-agent-options-)  
         * 1.2.1 [type](#-agent-)  
         * 1.2.2 [contact](#-callcenter_config-)  
         * 1.2.3 [status](#-status-)  
         * 1.2.4 [max-no-answer](#-max-no-answer-)  
         * 1.2.5 [wrap-up-time](#-wrap-up-time-)  
         * 1.2.6 [reject-delay-time](#-reject-delay-time-)  
         * 1.2.7 [busy-delay-time](#-busy-delay-time-)  
         * 1.2.8 [no-answer-delay-time](#-no-answer-delay-time-)  
         * 1.2.9 [reserve-agents](#reserve-agents)  
         * 1.2.10 [truncate-agents-on-load](#truncate-agents-on-load)  
         * 1.2.11 [truncate-tiers-on-load](#truncate-tiers-on-load)  
   * 1.3 [Queue options](#-agent-options-)  
         * 1.3.1 [strategy](#-strategy-)  
         * 1.3.2 [moh-sound](#-callcenter_config-)  
         * 1.3.3 [record-template](#-record-template-)  
         * 1.3.4 [time-base-score](#-time-base-score-)  
         * 1.3.5 [tier-rules-apply](#-tier-rules-apply-)  
         * 1.3.6 [tier-rule-wait-second](#-tier-rule-wait-second-)  
         * 1.3.7 [tier-rule-wait-multiply-level](#-tier-rule-wait-multiply-level-)  
         * 1.3.8 [tier-rule-no-agent-no-wait](#-tier-rule-no-agent-no-wait-)  
         * 1.3.9 [discard-abandoned-after](#-discard-abandoned-after-)  
         * 1.3.10 [abandoned-resume-allowed](#-abandoned-resume-allowed-)  
         * 1.3.11 [max-wait-time](#-max-wait-time-)  
         * 1.3.12 [max-wait-time-with-no-agent](#-max-wait-time-with-no-agent-)  
         * 1.3.13 [max-wait-time-with-no-agent-time-reached](#-max-wait-time-with-no-agent-time-reached-)  
         * 1.3.14 [ring-progressively-delay](#ring-progressively-delay)  
   * 1.4 [callcenter.conf.xml example](#-callcenterconfxml-example)  
   * 1.5 [](#-agent-)  
   * 1.6 [Put a caller into a queue](#put-a-caller-into-a-queue)  
   * 1.7 [Time of Day / Voicemail timeout Example](#time-of-day--voicemail-timeout-example)  
   * 1.8 [Distribution Strategy](#-distribution-strategy-)  
   * 1.9 [Time base score](#-time-base-score-)
* 2 [Agents](#-cc_agent-)  
   * 2.1 [Type](#-agent-)  
         * 2.1.1 [Callback](#-callback-)  
         * 2.1.2 [uuid-standby](#-uuid-standby-)  
   * 2.2 [Rejecting Calls](#-rejecting-calls-)  
   * 2.3 [Do not disturb](#-do-not-disturb-)  
   * 2.4 [Example Dialplan](#-example-dialplan-)  
         * 2.4.1 [Agent Login/Logout Example](#-agent-loginlogout-example)  
         * 2.4.2 [Zero-out for voicemail](#zero-out-for-voicemail)
* 3 [API Commands](#json-api-commands)  
   * 3.1 [callcenter\_config](#-callcenter_config-)  
         * 3.1.1 [agent](#-cc_agent-)  
         * 3.1.2 [tier](#-callcenter_config-)  
         * 3.1.3 [queue](#-agent-)
* 4 [JSON API Commands](#json-api-commands)  
   * 4.1 [Listing queues](#listing-queues)  
   * 4.2 [Listing agents for a queue](#listing-agents-for-a-queue)  
   * 4.3 [Listing members(callers) for a queue](#listing-memberscallers-for-a-queue)  
   * 4.4 [Listing tiers for a queue](#listing-tiers-for-a-queue)  
   * 4.5 [Listing members](#listing-members)  
   * 4.6 [Listing tiers](#listing-tiers)
...
* 6 [Events](#-events)  
   * 6.1 [Actions](#-callcenter_config-)  
         * 6.1.1 [agent-status-change](#-agent-status-change-)  
         * 6.1.2 [agent-state-change](#-agent-state-change-)  
         * 6.1.3 [agent-offering](#-callcenter_config-)  
         * 6.1.4 [bridge-agent-start](#-bridge-agent-start-)  
         * 6.1.5 [bridge-agent-end](#-bridge-agent-end-)  
         * 6.1.6 [bridge-agent-fail](#-bridge-agent-fail-)  
         * 6.1.7 [members-count](#-members-count-)  
         * 6.1.8 [member-queue-start](#-member-queue-start-)  
         * 6.1.9 [member-queue-end](#-member-queue-end-)  
   * 6.2 [Sample Scripts](#-sample-scripts)  
         * 6.2.1 [Python](#-callcenter_config-)  
         * 6.2.2 [Lua](#-agent-)
* 7 [See Also](#-callcenter_config-)
...
JSON API was added in [FS-8799](https://freeswitch.org/jira/browse/FS-8799?src=confmacro)  \-[Autentica](https://freeswitch.org/confluence/plugins/servlet/applinks/oauth/login-dance/authorize?applicationLinkID=c4b15fa3-ad57-3c05-af05-8c167cb92266) per visualizzare i dettagli del problema  and currently it support the following commands:
...
* <https://github.com/gonicus/fsqueuemon> \- Web status monitor for mod\_callcenter queues and agents

  
### Comments:

| This module mod\_callcenter is actually a **ACD** service. ![](/images/icons/contenttypes/comment_16.png) Posted by livem at lug 22, 2020 22:36 |
| ---------------------------------------------------------------------------------------------------------------------------------------------- |
