...
For CouchDB insertion (with FS-3721 fix) use for example an CouchDB URL like **[http://127.0.0.1:5984/cdr](http://127.0.0.1:5984/cdr)** where **cdr** is the database that will store your Call Detail Records. Make sure to set **encode-values** to false if you'd like plain JSON content.
