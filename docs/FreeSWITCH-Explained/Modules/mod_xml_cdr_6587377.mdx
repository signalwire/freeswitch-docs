...
\<settings>
   ...
   \<param name="url" value="[http://myhost/cdr.php>"/](http://myhost/cdr.php>"/)
...
| url                   | Webserver URL (you can specify this element more than once, and it will try each URL in order of succession until retries is reached. note retries is not per URL specified). Note URL is optional, mod\_xml\_cdr can write only to disk.                                                                                                                                                                                                                                                                                                                        | [http://myhost/cdr.php](http://myhost/cdr.php)            |
...
\<param name="url" value="[http://localhost/cgi-bin/fs-xml-cdr.pl>"/](http://localhost/cgi-bin/fs-xml-cdr.pl>"/)
