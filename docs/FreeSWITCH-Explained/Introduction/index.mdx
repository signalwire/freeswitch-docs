...
| [Event Socket](../Client-and-Developer-Interfaces/Event-Socket-Library/index.mdx)                    | Allows an outside program to interact with FreeSWITCH over a network connection. The [CLI ](../Client-and-Developer-Interfaces/1048948.mdx#or)uses the Event Socket to allow you to run commands and view the output of FreeSWITCH.                                                                                                                                                                                                                                                                                                                                                 |
