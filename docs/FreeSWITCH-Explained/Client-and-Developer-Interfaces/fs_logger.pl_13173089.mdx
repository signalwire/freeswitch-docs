...
Download the latest version from [Here](https://freeswitch.org/stash/projects/FS/repos/freeswitch-contrib/browse/mitchcapper) or short redirect url of: `<http://fluky.org/fs%5Flogger.pl>` and place it in the same directory as fs\_cli
