...
The idea of [Serving Configuration feature in JavaScript](https://wiki.freeswitch.org/wiki/Mod%5Flua/Serving%5FConfiguration) is that it should act as it is done in LUA:
