...
Returns the type of this event, either CUSTOM for custom events or one of the [built-in event types](../Event-Socket-Library/#gettype).
...
In your lua code, you can use `session:setHangupHook` to define the function to call when the session hangs up.
...
Instantiates a new [IVRMenu object](http://docs.freeswitch.org/group%5F%5Fswitch%5F%5Fivr%5F%5Fmenu.html#gaa3fe2784f98455258dd88ccd495c0931). To see a full example, go to the [Lua IVR Menu Example](./Lua-examples/Lua-IVR-Menu-Example_16352016.mdx) page.
...
| Where can I find the lua session api and non-session(freeswitch) api source code ?I want to learn more the implementation in FreeSWITCH.Are those all in **src\\mod\\languages\\mod\_lua** ? Which source file ?Thanks. ![](/images/icons/contenttypes/comment_16.png) Posted by livem at Oct 25, 2018 22:58                                                                                                                                                                                                                             |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| You can check [mod/languages/mod\_lua/freeswitch\_lua.h](https://freeswitch.org/stash/projects/FS/repos/freeswitch/browse/src/mod/languages/mod%5Flua/freeswitch%5Flua.h) and [mod/languages/mod\_lua/my\_swigable\_cpp.h](https://freeswitch.org/stash/projects/FS/repos/freeswitch/browse/src/mod/languages/mod%5Flua/my%5Fswigable%5Fcpp.h) to see what's implemented and then the corresponding \*.c files to see the actual implementation. ![](/images/icons/contenttypes/comment_16.png) Posted by ryharris at Dec 14, 2018 10:56 |
| Thank you very much ![](/images/icons/contenttypes/comment_16.png) Posted by livem at Dec 19, 2018 07:39                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Where can I find **session:setInputCallback** arg type value list ?One of type is **dtmf**. ![](/images/icons/contenttypes/comment_16.png) Posted by livem at Jan 17, 2019 04:24                                                                                                                                                                                                                                                                                                                                                         |
