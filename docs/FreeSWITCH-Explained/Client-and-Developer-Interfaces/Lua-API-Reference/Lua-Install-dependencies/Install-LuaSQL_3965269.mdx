...
LuaSQL is a simple interface from Lua to a DBMS -  [LuaSQL](http://keplerproject.org/luasql/)
...
* [Download and install LuaSQL](#download-and-install-luasql)  
...
* Script to install LuaSQL with Postgresql on Debian7 [Here](https://gist.github.com/areski/6ab7ee00d7025a1eaa97)
