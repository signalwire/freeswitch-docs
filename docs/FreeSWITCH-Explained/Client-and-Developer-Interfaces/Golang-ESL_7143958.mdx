...
| go build client.go && ./clientnot worked$ go build client.go && ./clientbash: ./client: No such file or directory ![](/images/icons/contenttypes/comment_16.png) Posted by denis at Aug 09, 2016 12:48 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
