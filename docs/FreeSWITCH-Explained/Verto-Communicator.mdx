...
This will leave a server running on your local machine serving the necessary files to Verto Communicator to work. Just open Chrome and browse to: [https://localhost:9001](https://localhost:9001).
