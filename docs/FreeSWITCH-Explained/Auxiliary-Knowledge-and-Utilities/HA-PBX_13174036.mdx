...
* 3 [Links to crap I don't want to forget](#links-to-crap-i-dont-want-to-forget)
...
# Links to crap I don't want to forget

* [Sofia recover (OOOOH!)](https://wiki.freeswitch.org/wiki/Freeswitch%5FHA "Freeswitch HA")
