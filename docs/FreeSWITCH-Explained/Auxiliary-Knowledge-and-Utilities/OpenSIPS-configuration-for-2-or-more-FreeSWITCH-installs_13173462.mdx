...
onreply_route[external_reply]
{
    ...
    xlog("L_INFO", "$ci|start|received external reply $rs $rr");
    xlog("L_INFO", "$ci|log|source $si:$sp");

    # This ensures that if a endpoint receives a call they can properly
    # transfer that call
...
onreply_route[internal_reply]
{
    ...
    {
        xlog("L_INFO", "$ci|start|received local internal reply $T_reply_code $rr");
    }
    else
    {
    ...
    # call id to the challenging server so it receives the reply
