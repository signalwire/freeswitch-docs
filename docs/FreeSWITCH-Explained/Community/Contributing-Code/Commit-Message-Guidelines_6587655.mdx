...
| "Avoid Merges"Instead, please rebase your branch onto our tree **before** submitting the commits to usAnd what if the commit has already been submitted and never evaluated, and a week later there are merge conflicts? What's the proper way of dealing with this situation? Drop the branch and start over (as I'm doing)? ![](/images/icons/contenttypes/comment_16.png) Posted by saumar at mag 18, 2017 17:56 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
