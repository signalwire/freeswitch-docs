...
To stop the SIP trace you will need to stop and restart FreeSWITCH without the TPORT\_LOG environment variable set. See [Troubleshooting FreeSWITCH](Troubleshooting-Freeswitch.mdx#about) for more information on SIP tracing.
...
* [Debugging FreeSWITCH](Debugging-Freeswitch.mdx#about)
