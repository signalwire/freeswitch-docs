...
# Ruby ESL
 ...
 Created by  John Boteler, last modified by  Attila Gulyas on 2019.11.05

Content exactly the same as [Ruby ESL](./Client-and-Developer-Interfaces/Ruby-ESL_13173554.mdx#ruby-examples) but with with less formatting.
...
ESL in Outbound async full mode (&lt;action application="socket" data="[localhost:8086](http://localhost:8086) async full"/>). It forks a process of every connection in order to support simultaneous sessions.
