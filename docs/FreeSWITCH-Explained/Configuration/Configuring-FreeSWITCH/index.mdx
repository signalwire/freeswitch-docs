...
See [c](../Default-Configuration_6587388.mdx#mod_vp8) [onf/sip\_profiles/](../Default-Configuration_6587388.mdx#configuration) in [Default Configuration](../Default-Configuration_6587388.mdx#mod_vp8).
...
See [c](../Default-Configuration_6587388.mdx#mod_vp8)[onf/sip\_profiles/](../Default-Configuration_6587388#configuration) in [Default Configuration](../Default-Configuration_6587388.mdx#mod_vp8).
...
See [Config\_1000.xml](../Default-Configuration_6587388#configuration) for a simple (1000.xml) configuration of a user (endpoint) which will register to FreeSWITCH.
