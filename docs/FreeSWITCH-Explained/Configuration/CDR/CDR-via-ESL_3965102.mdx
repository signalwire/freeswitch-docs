...
[Event Socket Library](../../Client-and-Developer-Interfaces/Event-Socket-Library/index.mdx) allows one to retrieve CDRs in realtime. The CDR information are provided in the event **CHANNEL\_HANGUP\_COMPLETE**.
