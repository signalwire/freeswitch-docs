...
# Sofia Gateway Authentication Params 
 ...
 Created by  Italo Rossi, last modified on 2015.01.16
...
* 1 [Gateway Authentication](#gateway-authentication)
...
| Missing from this list is **outbound-proxy**, used to route outbound calls. If you use just **proxy** that will override **realm** and auth will fail if realm is required and is different to proxy. ![](/images/icons/contenttypes/comment_16.png) Posted by dcw67 at ago 18, 2020 20:33                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
