...
At the moment FreeSWITCH does not work with the new dahdi drivers from Digium, which provides native support for the B410P (BRI) card. In order to use that card, it's necessary to install Bristuff and apply a patch:
 ...
 1\. Download bristuff from: [http://www.junghanns.net/downloads/bristuff-0.4.0-RC3d.tar.gz](http://www.junghanns.net/downloads/bristuff-0.4.0-RC3d.tar.gz) and extract the files;

 2\. Replace qozap/qozap.c and qozap/qozap.h with the files from: [http://svn.digium.com/view/zaptel/team/mattf/bri-related/](http://svn.digium.com/view/zaptel/team/mattf/bri-related/)
