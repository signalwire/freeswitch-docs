...
* Broadvoice has a funny DNS situation, use the following fix. (Broadvoice kept on returning [403 Forbidden messages](../../Troubleshooting-Debugging/SIP-Protocol-Messages.mdx#4xx-request-failure-responses) until I modified my DNS entries within the hosts file)  
