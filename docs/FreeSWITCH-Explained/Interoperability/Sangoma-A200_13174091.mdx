...
I followed the instructions on [http://wiki.sangoma.com/wanpipe-freeswitch-install](http://wiki.sangoma.com/wanpipe-freeswitch-install) to install the wanpipe drivers and FreeSWITCH with these exceptions:
