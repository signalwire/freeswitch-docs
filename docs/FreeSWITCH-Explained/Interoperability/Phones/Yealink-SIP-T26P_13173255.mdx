...
It's pretty well documented that the OpenVPN configuration on this phone is wonky. [http://www.pluteus.at/HelpDesk/ViewKBIssue.aspx?IssueID=852](http://www.pluteus.at/HelpDesk/ViewKBIssue.aspx?IssueID=852)
