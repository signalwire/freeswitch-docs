...
* SIP profiles to route calls to a specific context (related pages/articles: [Configuring FreeSWITCH#SIPProfilessip-profiles](../Configuration/Configuring-FreeSWITCH/index.mdx#configuration), [Sofia Configuration Files](../Configuration/Sofia-SIP-Stack/Sofia-Configuration-Files_7144453.mdx)), [Sofia SIP Stack](../Configuration/Sofia-SIP-Stack/index.mdx#faq), [mod\_sofia](../Modules/mod_sofia_1048707.mdx#about))
