...
| bridge\_hangup\_cause | The [reason](../../Troubleshooting-Debugging/Hangup-Cause-Code-Table.mdx#about) a call ended, for example NO\_ANSWER, NORMAL\_CLEARING or USER\_BUSY |
