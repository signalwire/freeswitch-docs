...
(This page was the original document copied from the old wiki. The Docs Team is currently merging it with the improved [XML Dialplan page](./XML-Dialplan/index.mdx#about).) The XML dialplan is the default dialplan used by FreeSwitch.
...
* **source** Name of the FreeSWITCH module that received the call
* **chan\_name** Name of the current channel. Give us examples when this one can be used.
