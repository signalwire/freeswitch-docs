...
#### [process_cdr](../../Introduction/Variables/index.mdx#variables)
...
#### [hold_events](../../Introduction/Variables/index.mdx#variables)
...
#### [transfer_to](../../Introduction/Variables/index.mdx#variables)
...
#### [hangup_cause](../../Introduction/Variables/index.mdx#variables)
...
#### [hangup_cause_q850](../../Introduction/Variables/index.mdx#variables)
...
Related discussion; [Link](http://lists.freeswitch.org/pipermail/freeswitch-users/2012-April/082835.html)
...
Set on the inbound leg to control what caller ID name appears in the caller phone's display. Also see [ignore\_display\_updates](https://wiki.freeswitch.org/index.php?title=Ignore%5Fdisplay%5Fupdates&action=edit&redlink=1 "Ignore display updates (page does not exist)") which affect the processing of these variables.
...
[Link](https://freeswitch.org/confluence/display/FREESWITCH/mod%5Fsofia+variables#mod%5Fsofiavariables-auto%5Fanswer%5Fdestination)
