...
Make either `*` (star) or `#` (bar/pound/square) interrupt the subsequent playback, [tone\_stream](../Modules/mod-dptools/gentones/Tone-stream/Tone_stream_6586599.mdx#about), [say](../Modules/mod_dptools_1970333.mdx#-c), recording, etc. operation:
