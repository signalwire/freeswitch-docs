...
![(attenzione)](/images/icons/emoticons/warning.svg) This should NOT be confused with [sip\_profile\_name](../FreeSWITCH-Explained/Dialplan/Variables-Master-List_16352570.mdx#voicemail_profile_name).
