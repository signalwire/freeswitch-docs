...
# Openzap Configuration Examples 
 ...
 Created by  John Boteler on 2015.05.12
...
* 1 [Using with PRI](#-freeswitch--openzap-configuration-examples-)  
   * 1.1 [OpenZAP native stack](#openzap-native-stack-)  
   * 1.2 [libpri compatibility stack](#libpri-compatibility-stack-)
* 2 [Using with PRI and CAS on a 4 Port Card](#-using-with-pri-and-cas-on-a-4-port-card-)
* 3 [Using with BRI](#-freeswitch--openzap-configuration-examples-)
* 4 [Using Digium TDM400P card](#-using-digium-tdm400p-card-)
...
Sample config for a 4 port tor2 (corresponds to second [Openzap.conf example](https://wiki.freeswitch.org/wiki/Openzap.conf%5FExamples "Openzap.conf Examples"))
