...
# Event List 
 ...
 Created by  John Boteler, last modified by  Attila Gulyas on 2019.12.16
...
* [0\. About](#0-about)
* [1\. Channel events](#1-channel-events)  
   * [1.1 CHANNEL\_CALLSTATE event](#11-channel_callstate-event)  
   * [1.2 CHANNEL\_CREATE event](#12-channel_create-event)  
   * [1.3 CHANNEL\_DESTROY event](#13-channel_destroy-event)  
   * [1.4 CHANNEL\_STATE event](#14-channel_state-event)  
   * [1.5 CHANNEL\_ANSWER event](#15-channel_answer-event)  
   * [1.6 CHANNEL\_HANGUP event](#16-channel_hangup-event)  
   * [1.7 CHANNEL\_HANGUP\_COMPLETE event](#17-channel_hangup_complete-event)  
   * [1.8 CHANNEL\_EXECUTE event](#18-channel_execute-event)  
   * [1.9 CHANNEL\_EXECUTE\_COMPLETE event](#19-channel_execute_complete-event)  
   * [1.10 CHANNEL\_BRIDGE event](#110-channel_bridge-event)  
   * [1.11 CHANNEL\_UNBRIDGE event](#111-channel_unbridge-event)  
   * [1.12 CHANNEL\_PROGRESS event](#112-channel_progress-event)  
   * [1.13 CHANNEL\_PROGRESS\_MEDIA event](#113-channel_progress_media-event)  
   * [1.14 CHANNEL\_OUTGOING event](#114-channel_outgoing-event)  
   * [1.15 CHANNEL\_PARK event](#115-channel_park-event)  
   * [1.16 CHANNEL\_UNPARK event](#116-channel_unpark-event)  
   * [1.17 CHANNEL\_APPLICATION event](#117-channel_application-event)  
   * [1.18 CHANNEL\_HOLD event](#118-channel_hold-event)  
   * [1.19 CHANNEL\_UNHOLD event](#119-channel_unhold-event)  
   * [1.20 CHANNEL\_ORIGINATE event](#120-channel_originate-event)  
   * [1.21 CHANNEL\_UUID event](#121-channel_uuid-event)
* [2\. System events](#2-system-events)  
   * [SHUTDOWN](#shutdown)  
...
* [3\. Other events](#3-other-events)  
   ...
   * [ALL](#all)
* [6\. Undocumented events](#6-undocumented-events)  
   * [LOG](#log)  
...
**CHANNEL\_CALLSTATE example** Espandi fonte 
...
**CHANNEL\_CREATE example** Espandi fonte 
...
**CHANNEL\_DESTROY example** Espandi fonte 
...
**CHANNEL\_STATE example** Espandi fonte 
...
**CHANNEL\_ANSWER - outbound example** Espandi fonte 
...
**CHANNEL\_ANSWER - inbound example** Espandi fonte 
...
**CHANNEL\_HANGUP example** Espandi fonte 
...
**CHANNEL\_HANGUP\_COMPLETE example** Espandi fonte 
...
**CHANNEL\_EXECUTE example** Espandi fonte 
...
**CHANNEL\_EXECUTE\_COMPLETE example** Espandi fonte 
...
**CHANNEL\_BRIDGE example** Espandi fonte 
...
**CHANNEL\_UNBRIDGE example** Espandi fonte 
...
**CHANNEL\_APPLICATION example** Espandi fonte 
...
**CHANNEL\_UUID example** Espandi fonte 
...
| **BACKGROUND\_JOB**"Server response" should update:Content-Type: command/reply Reply-Text: +OK Job-UUID: e3054f48-151e-11dc-842a-d3a3942d3d63Job-UUID: e3054f48-151e-11dc-842a-d3a3942d3d63 add **Job-UUID** line. ![](/images/icons/contenttypes/comment_16.png) Posted by livem at lug 20, 2016 22:55 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
