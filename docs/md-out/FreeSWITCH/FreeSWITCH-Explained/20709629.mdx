...
# mod_pocketsphinx \[duplicate\] 

 Created by  livem Chan, last modified by  Attila Gulyas on 2019.10.30

Duplicate of mod\_pocketsphinx

Seems to be an identical version of [mod\_pocketsphinx](./Modules/mod_pocketsphinx_13173540.mdx#--), which is has been updated more recently, and its edit history suggests being the original.
...
* 2 [Grammar Files](#grammar-files)
* 3 [Setting up the Pizza Demo](#-freeswitch--mod_pocketsphinx-duplicate-)
* 4 [Other info](#-freeswitch--mod_pocketsphinx-duplicate-)
* 5 [Acoustic Model for german language](#-freeswitch--mod_pocketsphinx-duplicate-)  
   * 5.1 [Requirements](#requirements)  
   * 5.2 [Process](#-freeswitch--mod_pocketsphinx-duplicate-)
* 6 [See Also](#-freeswitch--mod_pocketsphinx-duplicate-)
...
4. enable mod\_pocketsphinx in the [Modules.conf.xml](Modules/index.mdx#about)
...
* Download the sounds files from [here](http://www.freeswitch.org/eg/pizza%5Fsounds.tar.gz)
...
* [mod\_dptools: play\_and\_detect\_speech](./Modules/mod-dptools/6586714.mdx#lua)
