...
# JavaScript API Reference 
 ...
 Created by  N Oliver, last modified by  Henning Heedfeld on 2022.10.20
...
* 1 [FreeSWITCH DB Access From JavaScript](#freeswitch-db-access-from-javascript)
* 2 [apiExecute](#apiexecute)  
   * 2.1 [apiExecute Notes](#apiexecute-notes)
* 3 [bridge](#-freeswitch--javascript-api-reference-)
* 4 [callback](#callback)  
   * 4.1 [Returns:](#returns)  
         * 4.1.1 [Recording](#recording)  
         * 4.1.2 [Playing Back](#playing-back)  
         * 4.1.3 [Bridge](#-freeswitch--javascript-api-reference-)  
         * 4.1.4 [Other](#-freeswitch--javascript-api-reference-)  
   * 4.2 [Callback Examples](#callback-examples)
...
* `session1` ([Session](#-freeswitch--javascript-api-reference-)) - one session to bridge
* `session2` ([Session](#-freeswitch--javascript-api-reference-)) - the other session to bridge
...
**sayPhrase example** Espandi fonte 
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| You're right, using \`new File()\` works if you put \`use('File');\` at the top of your JS script, but if you try to use the methods you'll get \`Exception: Not yet implemented\` ![](/images/icons/contenttypes/comment_16.png) Posted by TBG at lug 05, 2021 05:50                                         |
