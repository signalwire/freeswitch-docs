...
# Event Types (Classes, or Names, of Events) 
 ...
 Created by  Giovanni Maruzzelli, last modified by  Attila Gulyas on 2019.11.07
...
* 1 [Event Type (Name or Class) List](#event-type-name-or-class-list)  
   * 1.1 [Event Types (Classes)](#-freeswitch--event-types-classes-or-names-of-events-)
