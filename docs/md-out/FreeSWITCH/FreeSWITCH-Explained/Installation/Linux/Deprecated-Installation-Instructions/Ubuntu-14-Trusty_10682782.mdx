...
# Ubuntu 14 Trusty 
 ...
 Created by  Ken Rice, last modified by  John Boteler on 2022.03.21
...
| \`apt-get install cowbuilder\` should also be included ![](/images/icons/contenttypes/comment_16.png) Posted by jnankin at giu 13, 2017 15:21 |
| -------------------------------------------------------------------------------------------------------------------------------------------- |
