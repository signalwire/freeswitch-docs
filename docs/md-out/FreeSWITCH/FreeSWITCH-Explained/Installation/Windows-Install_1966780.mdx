...
| Hello I am trying to install Windows FreeSWITCH, installers do not work .msi.to open the console closes immediately. and compiled with Visual Studio gives me error ![](/images/icons/contenttypes/comment_16.png) Posted by cynttiam at giu 04, 2015 12:55 |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Please ask on the #freeswitch irc channel or the freeswitch-users mailing list. Sorry you are having trouble. ![](/images/icons/contenttypes/comment_16.png) Posted by boteman at giu 12, 2015 12:00                                                        |
