...
# macOS 24x7 Preparation 
 ...
 Created by  Mario G, last modified on 2020.09.24
...
* 6 [Log Segmentation and Clearing](#log-segmentation-and-clearing)  
   * 6.1 [Automatic Log Segmentation](#automatic-log-segmentation)  
         * 6.1.1 [Create Log Segment Script](#create-log-segment-script)  
         * 6.1.2 [Create Log Segment plist](#create-log-segment-plist)  
   * 6.2 [Automatic Log Clearing](#automatic-log-clearing)  
         * 6.2.1 [Create Log Clear Script](#create-log-clear-script)  
         * 6.2.2 [Create Log Clear plist](#create-log-clear-plist)  
   * 6.3 [Automatic Log Rename at Login](#automatic-log-rename-at-login)  
         * 6.3.1 [Create Rename Script](#create-rename-script)  
         * 6.3.2 [Setup macOS Account to Run the Rename Script](#setup-macos-account-to-run-the-rename-script)
