...
* 1 [Knowledge](#-freeswitch--macos-homebrew-installation-)
* 2 [Overview](#-freeswitch--macos-homebrew-installation-)
* 3 [Preparation](#preparation)  
   * 3.1 [Backup](#-freeswitch--macos-homebrew-installation-)  
...
* 4 [Installation Directories](#installation-directories)  
   * 4.1 [Homebrew FreeSWITCH Directories](#non-homebrew-freeswitch-directories)  
   * 4.2 [Non-Homebrew FreeSWITCH Directories](#non-homebrew-freeswitch-directories)
...
* 9 [Removal](#-freeswitch--macos-homebrew-installation-)  
...
* Homebrew and prerequisites [runtime](http://en.wikipedia.org/wiki/Runtime%5Flibrary) located in /usr/local
* FreeSWITCH™ [runtime](http://en.wikipedia.org/wiki/Runtime%5Flibrary) located in /usr/local/opt/freeswitch
* FreeSWITCH™ [c](http://en.wikipedia.org/wiki/Runtime%5Flibrary)onfiguration located in /usr/local/opt/freeswitch/etc/freeswitch
...
* FreeSWITCH™ [c](http://en.wikipedia.org/wiki/Source%5Fcode)onfiguration located in /usr/local/freeswitch/conf
* FreeSWITCH™ prerequisite [source](http://en.wikipedia.org/wiki/Source%5Fcode) and [runtime](http://en.wikipedia.org/wiki/Runtime%5Flibrary) directories in /usr/local
