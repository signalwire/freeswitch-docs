...
* 2 [Structure of a Profile](#structure-of-a-profile)  
   ...
   * 2.2 [Parameters](#-basic-parameters-)  
         * 2.2.1 [Basic Parameters](#-basic-parameters-)  
                  ...
                  * 2.2.1.2 [shutdown-on-fail](#-shutdown-on-fail-)  
                  * 2.2.1.3 [user-agent-string](#-user-agent-string-)  
                  ...
                  * 2.2.1.13 [tcp-keepalive](#-tcp-keepalive-)  
                  * 2.2.1.14 [tcp-pingpong](#-tcp-pingpong-)  
                  * 2.2.1.15 [tcp-ping2pong](#-tcp-ping2pong-)  
                  * 2.2.1.16 [dialplan](#-default-configuration-file-)  
         * 2.2.2 [Media related parameters](#-media-related-parameters-)  
                  * 2.2.2.1 [resume-media-on-hold](#-resume-media-on-hold-)  
                  * 2.2.2.2 [bypass-media-after-att-xfer](#-bypass-media-after-att-xfer-)  
                  * 2.2.2.3 [bypass-media-after-hold](#-bypass-media-after-hold-)  
                  * 2.2.2.4 [inbound-bypass-media](#-inbound-bypass-media-)  
                  * 2.2.2.5 [inbound-proxy-media](#-inbound-proxy-media-)  
                  * 2.2.2.6 [disable-rtp-auto-adjust](#-disable-rtp-auto-adjust-)  
                  * 2.2.2.7 [ignore-183nosdp](#-ignore-183nosdp-)  
                  * 2.2.2.8 [enable-soa](#-default-configuration-file-)  
                  * 2.2.2.9 [t38-passthru](#-t38-passthru-)  
         * 2.2.3 [Codecs related options](#-codecs-related-options-)  
                  * 2.2.3.1 [inbound-codec-prefs](#-inbound-codec-prefs-)  
                  * 2.2.3.2 [outbound-codec-prefs](#-outbound-codec-prefs-)  
                  * 2.2.3.3 [codec-prefs](#-outbound-codec-prefs-)  
                  * 2.2.3.4 [inbound-codec-negotiation](#-inbound-codec-negotiation-)  
                  * 2.2.3.5 [inbound-late-negotiation](#-inbound-late-negotiation-)  
                  * 2.2.3.6 [bitpacking](#-default-configuration-file-)  
                  * 2.2.3.7 [disable-transcoding](#-disable-transcoding-)  
                  * 2.2.3.8 [renegotiate-codec-on-reinvite](#-renegotiate-codec-on-reinvite-)  
         * 2.2.4 [STUN](#-default-configuration-file-)  
                  * 2.2.4.1 [ext-rtp-ip](#-ext-rtp-ip-)  
                  * 2.2.4.2 [ext-sip-ip](#-ext-sip-ip-)  
                  * 2.2.4.3 [stun-enabled](#-stun-enabled-)  
                  * 2.2.4.4 [stun-auto-disable](#-stun-auto-disable-)  
         * 2.2.5 [NATing](#-default-configuration-file-)  
                  * 2.2.5.1 [apply-nat-acl](#-apply-nat-acl-)  
                  * 2.2.5.2 [aggressive-nat-detection](#-aggressive-nat-detection-)  
         * 2.2.6 [VAD and CNG](#-default-configuration-file-)  
                  * 2.2.6.1 [vad](#-default-configuration-file-)  
                  * 2.2.6.2 [suppress-cng](#-suppress-cng)  
         * 2.2.7 [NDLB (A.K.A. No device left behind)](#-ndlb-aka-no-device-left-behind)  
                  * 2.2.7.1 [NDLB-force-rport](#ndlb-force-rport)  
                  * 2.2.7.2 [NDLB-broken-auth-hash](#-ndlb-broken-auth-hash)  
                  * 2.2.7.3 [NDLB-received-in-nat-reg-contact](#-ndlb-received-in-nat-reg-contact)  
                  * 2.2.7.4 [NDLB-sendrecv-in-session](#-ndlb-sendrecv-in-session)  
                  * 2.2.7.5 [NDLB-allow-bad-iananame](#-ndlb-allow-bad-iananame)  
         * 2.2.8 [Call ID](#-default-configuration-file-)  
                  * 2.2.8.1 [inbound-use-callid-as-uuid](#-inbound-use-callid-as-uuid-)  
                  * 2.2.8.2 [outbound-use-uuid-as-callid](#-outbound-use-uuid-as-callid-)  
         * 2.2.9 [TLS](#-default-configuration-file-)  
                  * 2.2.9.1 [tls](#-default-configuration-file-)  
                  * 2.2.9.2 [tls-only](#-default-configuration-file-)  
                  * 2.2.9.3 [tls-bind-params](#-tls-bind-params-)  
                  * 2.2.9.4 [tls-sip-port](#-tls-sip-port-)  
                  * 2.2.9.5 [tls-cert-dir](#-tls-cert-dir-)  
                  * 2.2.9.6 [tls-version](#-default-configuration-file-)  
                  * 2.2.9.7 [tls-passphrase](#-tls-passphrase-)  
                  * 2.2.9.8 [tls-verify-date](#-tls-verify-date-)  
                  * 2.2.9.9 [tls-verify-policy](#-tls-verify-policy-)  
                  * 2.2.9.10 [tls-verify-depth](#-tls-verify-depth-)  
                  * 2.2.9.11 [tls-verify-in-subjects](#-tls-verify-in-subjects-)  
         * 2.2.10 [DTMF](#-default-configuration-file-)  
                  * 2.2.10.1 [rfc2833-pt](#-default-configuration-file-)  
                  * 2.2.10.2 [dtmf-duration](#-dtmf-duration-)  
                  * 2.2.10.3 [dtmf-type](#-default-configuration-file-)  
                  * 2.2.10.4 [pass-rfc2833](#-default-configuration-file-)  
                  * 2.2.10.5 [liberal-dtmf](#-liberal-dtmf)  
         * 2.2.11 [SIP Related options](#-sip-related-options-)  
                  * 2.2.11.1 [enable-timer](#-default-configuration-file-)  
                  * 2.2.11.2 [session-timeout](#-session-timeout-)  
                  * 2.2.11.3 [enable-100rel](#-enable-100rel-)  
                  * 2.2.11.4 [minimum-session-expires](#-minimum-session-expires-)  
                  * 2.2.11.5 [sip-options-respond-503-on-busy](#-sip-options-respond-503-on-busy-)  
                  * 2.2.11.6 [sip-force-expires](#-sip-force-expires-)  
                  * 2.2.11.7 [sip-expires-max-deviation](#-sip-expires-max-deviation-)  
                  * 2.2.11.8 [outbound-proxy](#-outbound-proxy-)  
                  * 2.2.11.9 [send-display-update](#-send-display-update-)  
         * 2.2.12 [RTP Related options](#-rtp-related-options-)  
                  * 2.2.12.1 [auto-jitterbuffer-msec](#-auto-jitterbuffer-msec-)  
                  * 2.2.12.2 [rtp-timer-name](#-rtp-timer-name-)  
                  * 2.2.12.3 [rtp-rewrite-timestamps](#-rtp-rewrite-timestamps-)  
                  * 2.2.12.4 [media\_timeout](#-media_timeout-)  
                  * 2.2.12.5 [media\_hold\_timeout](#-media_timeout-)  
                  * 2.2.12.6 [rtp-autoflush-during-bridge](#-rtp-autoflush-during-bridge-)  
                  * 2.2.12.7 [rtp-autoflush](#-rtp-autoflush-)  
         * 2.2.13 [Auth](#-default-configuration-file-)  
                  * 2.2.13.1 [challenge-realm](#-challenge-realm-)  
                  * 2.2.13.2 [accept-blind-auth](#-accept-blind-auth-)  
                  * 2.2.13.3 [auth-calls](#-default-configuration-file-)  
                  * 2.2.13.4 [log-auth-failures](#-log-auth-failures-)  
                  * 2.2.13.5 [auth-all-packets](#-auth-all-packets-)  
         * 2.2.14 [Registration](#-registration-)  
                  * 2.2.14.1 [disable-register](#-disable-register-)  
                  * 2.2.14.2 [multiple-registrations](#-multiple-registrations-)  
                  * 2.2.14.3 [max-registrations-per-extension](#-max-registrations-per-extension-)  
                  * 2.2.14.4 [accept-blind-reg](#-accept-blind-reg-)  
                  * 2.2.14.5 [inbound-reg-force-matching-username](#-inbound-reg-force-matching-username-)  
                  * 2.2.14.6 [force-publish-expires](#-force-publish-expires-)  
                  * 2.2.14.7 [force-register-domain](#-force-register-domain-)  
                  * 2.2.14.8 [force-register-db-domain](#-force-register-db-domain-)  
                  * 2.2.14.9 [send-message-query-on-register](#-send-message-query-on-register-)  
                  * 2.2.14.10 [unregister-on-options-fail](#-unregister-on-options-fail-)  
                  * 2.2.14.11 [nat-options-ping](#-nat-options-ping-)  
                  * 2.2.14.12 [all-reg-options-ping](#-all-reg-options-ping-)  
                  * 2.2.14.13 [registration-thread-frequency](#-registration-thread-frequency-)  
                  * 2.2.14.14 [inbound-reg-in-new-thread](#-inbound-reg-in-new-thread-)  
                  * 2.2.14.15 [ping-mean-interval](#ping-mean-interval)  
         * 2.2.15 [ping-thread-frequency](#-registration-thread-frequency-)  
         * 2.2.16 [Subscription](#-subscription-)  
                  * 2.2.16.1 [force-subscription-expires](#-force-subscription-expires-)  
                  * 2.2.16.2 [force-subscription-domain](#-force-subscription-domain-)  
         * 2.2.17 [Presence](#-default-configuration-file-)  
                  * 2.2.17.1 [manage-presence](#-manage-presence-)  
                  * 2.2.17.2 [dbname](#-default-configuration-file-)  
                  * 2.2.17.3 [presence-hold-state](#-presence-hold-state-)  
                  * 2.2.17.4 [presence-hosts](#-presence-hosts-)  
                  * 2.2.17.5 [presence-privacy](#-presence-privacy-)  
                  * 2.2.17.6 [send-presence-on-register](#-send-presence-on-register-)  
         * 2.2.18 [CallerID Related options](#-callerid-related-options-)  
                  * 2.2.18.1 [caller-id type](#-caller-id-type-)  
                  * 2.2.18.2 [pass-callee-id](#-pass-callee-id-)  
         * 2.2.19 [Other (TO DO)](#-default-configuration-file-)  
                  * 2.2.19.1 [hold-music](#-default-configuration-file-)  
                  * 2.2.19.2 [disable-hold](#-disable-hold-)  
                  * 2.2.19.3 [apply-inbound-acl](#-apply-inbound-acl-)  
                  * 2.2.19.4 [apply-register-acl](#-apply-register-acl-)  
                  * 2.2.19.5 [apply-proxy-acl](#-apply-proxy-acl-)  
                  * 2.2.19.6 [record-template](#-record-template-)  
                  * 2.2.19.7 [max-proceeding](#-max-proceeding-)  
                  * 2.2.19.8 [bind-params](#-tls-bind-params-)  
                  * 2.2.19.9 [disable-transfer](#-disable-transfer-)  
                  * 2.2.19.10 [manual-redirect](#-manual-redirect-)  
                  * 2.2.19.11 [enable-3pcc](#-default-configuration-file-)  
                  * 2.2.19.12 [nonce-ttl](#-default-configuration-file-)  
                  * 2.2.19.13 [sql-in-transactions](#-sql-in-transactions-)  
                  * 2.2.19.14 [odbc-dsn](#-default-configuration-file-)  
                  * 2.2.19.15 [mwi-use-reg-callid](#-mwi-use-reg-callid-)  
