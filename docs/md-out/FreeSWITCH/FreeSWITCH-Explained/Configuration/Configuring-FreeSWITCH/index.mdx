...
# Configuring FreeSWITCH 
 ...
 Created by  Brian West, last modified by  Attila Gulyas on 2020.08.13
...
Only mentioned in [Debian 9 Stretch (Obsolete)](../../Installation/Linux/Deprecated-Installation-Instructions/15139022.mdx#about) installation manual. The only other info is [from Andrey Volk](https://stackoverflow.com/questions/57634856/trying-to-connect-to-a-postgresql-db-via-pgsql-dsn-returns-err-unable-to-ope):
