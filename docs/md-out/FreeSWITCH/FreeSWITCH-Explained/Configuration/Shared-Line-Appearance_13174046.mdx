...
| Are there any SIP Soft Phones that are known to support Broadsoft SCA? ![](/images/icons/contenttypes/comment_16.png) Posted by tom@tomlynn.com at mag 28, 2017 16:36 |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
