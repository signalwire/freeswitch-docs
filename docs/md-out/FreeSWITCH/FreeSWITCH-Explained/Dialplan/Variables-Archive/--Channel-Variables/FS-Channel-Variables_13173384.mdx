...
* Keep in mind that some channel variables may not be set during the dialplan parsing phase. See **inline actions** section of [Dialplan\_XML](../../XML-Dialplan/index.mdx#why) for more information. **&lt;MISSING LINK>**
