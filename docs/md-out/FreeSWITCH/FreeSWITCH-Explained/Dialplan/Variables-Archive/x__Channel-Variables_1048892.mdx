...
# \_\_Channel Variables 
 ...
 Created by  Brian West, last modified by  livem Chan on 2019.05.17
...
| This page needs the sip\_\*\_media variables to be updated to rtp\_\*\_media variables. ![](/images/icons/contenttypes/comment_16.png) Posted by boteman at giu 21, 2014 19:07                                                                                                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| Found this in old wiki for playback\_terminators variable: Git Committed 38b3f43d: add prefix chars to playback\_terminators '+' means include the term in the stringand x means include the char and return SWITCH\_STATUS\_RESTARTeg #+\* only includes the \* if you type it but not the # ![](/images/icons/contenttypes/comment_16.png) Posted by tomasb at dic 01, 2015 14:01                                                                                                         |
| same for sip\_force\_audio\_fmtp . It should be rtp\_force\_audio\_fmtp ![](/images/icons/contenttypes/comment_16.png) Posted by dragos\_oancea at set 23, 2016 14:01                                                                                                                                                                                                                                                                                                                       |
...
| also at wiki we have about playback\_terminators ----  keyword 'any' will terminate playback when any key (1234567890\*#) is pressed. ![](/images/icons/contenttypes/comment_16.png) Posted by Pechen at gen 09, 2017 06:26                                                                                                                                                                                                                                                                 |
