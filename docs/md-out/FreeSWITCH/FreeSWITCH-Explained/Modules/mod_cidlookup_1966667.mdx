...
# mod_cidlookup 
 ...
 Created by  John Boteler, last modified by  Jim Lynch on 2018.05.10
...
**Sample cidlookup configuration** Espandi fonte 
...
**Trivial sample configuration** Espandi fonte 
...
**Sample schema for PostgreSQL** Espandi fonte 
...
**Dialplan example** Espandi fonte 
...
**OpenCNAM Professional config** Espandi fonte 
...
**PHP web server config** Espandi fonte 
...
**Dialplan context public** Espandi fonte 
