...
# mod_pocketsphinx 
 ...
 Created by  Aline Cristine Freire de Araújo, last modified by  Mario G on 2020.07.19
...
* 3 [Setting up the Pizza Demo](#sphinx-ii)
* 4 [Other info](#other-info)
* 5 [Acoustic Model for german language](#sphinx-ii)  
...
| [Joshua Young](https://freeswitch.org/confluence/display/~joshebosh) Can this page move to [mod\_pocketsphinx \[duplicate\]](../20709629.mdx#--) ![](/images/icons/contenttypes/comment_16.png) Posted by livem at mag 16, 2019 22:28 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
