...
# mod_spandsp 
 ...
 Created by  Italo Rossi, last modified by  Sergey Safarov on 2018.04.29
...
* 2 [Fax](#fax)  
   * 2.1 [Status](#status)  
   * 2.2 [Invoking the app from the XML dialplan](#invoking-the-app-from-the-xml-dialplan)  
         * 2.2.1 [For receiving a fax](#for-receiving-a-fax)  
         * 2.2.2 [For transmitting a fax](#for-transmitting-a-fax)  
         * 2.2.3 [Manual fax transmission](#manual-fax-transmission)  
         * 2.2.4 [Execute based on fax session outcome](#execute-based-on-fax-session-outcome)  
   * 2.3 [Invoking the app from the CLI](#invoking-the-app-from-the-cli)  
         * 2.3.1 [For transmitting a fax](#for-transmitting-a-fax)  
         * 2.3.2 [For transmitting a fax over ulaw from a SIP T.38 source](#for-transmitting-a-fax-over-ulaw-from-a-sip-t38-source)  
   * 2.4 [fax2mail: Emailing the fax upon receipt](#fax2mail-emailing-the-fax-upon-receipt)  
   * 2.5 [mail2fax: Faxing a received mail](#mail2fax-faxing-a-received-mail)  
   * 2.6 [Configuring the app](#configuring-the-app)  
   * 2.7 [Controlling the app](#controlling-the-app)  
   * 2.8 [Checking the results](#checking-the-results)  
         * 2.8.1 [Fax result code](#spandsptxfaxresult)  
   * 2.9 [t38\_gateway App](#t38_gateway-app)  
         * 2.9.1 [T.38 Reinvite](#t38-reinvite)  
         * 2.9.2 [T.38 Transcode](#spandsptxfaxresult)  
   * 2.10 [Receive Faxes](#receive-faxes)  
   * 2.11 [Transmit Faxes](#transmit-faxes)  
   * 2.12 [Fax Tone Detection](#stop-fax-tone-detection)  
         * 2.12.1 [Full Example](#full-example)  
   * 2.13 [Stop Fax Tone Detection](#stop-fax-tone-detection)
* 3 [Examples](#examples)  
   * 3.1 [Outbound Fax T.38 to TDM](#outbound-fax-t38-to-tdm)  
   * 3.2 [Inbound Fax TDM to T.38](#inbound-fax-tdm-to-t38)  
   * 3.3 [Internal T.38 to T.38](#internal-t38-to-t38)
* 4 [Results](#spandsptxfaxresult)  
   * 4.1 [Questions I got during testing](#questions-i-got-during-testing)
* 5 [Events](#events)  
...
* 6 [Troubleshooting](#troubleshooting)  
   * 6.1 [Common Issues](#common-issues)  
   * 6.2 [Suggested Process](#suggested-process)  
   * 6.3 [Example](#example)  
   * 6.4 [Further debugging](#further-debugging)
* 7 [Tone Detection](#fax-tone-detection)  
   * 7.1 [DTMF](#dtmf)  
         * 7.1.1 [Related Tone Channel Variables](#related-tone-channel-variables)  
         * 7.1.2 [Dialplan Applications](#dialplan-applications)  
   * 7.2 [Call Progress](#call-progress)  
         * 7.2.1 [Configuration](#configuration)  
         * 7.2.2 [Dialplan Applications](#dialplan-applications)  
         * 7.2.3 [APIs](#apis)  
         * 7.2.4 [Events](#events)
* 8 [Codecs](#codecs)
* 9 [Software Modem](#software-modem)  
   * 9.1 [COM Port Setting for Windows](#com-port-setting-for-windows)
