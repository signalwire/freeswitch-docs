...
# mod_format_cdr 
 ...
 Created by  Italo Rossi, last modified by  Jim Lynch on 2018.05.11
...
| **format\_cdr.conf.xml Configuration for PHP Example**&lt;param name="format" value="json"/>&lt;param name="url" value="http://127.0.0.1:8000/cdr.php"/\>&lt;param name="encode" value="true"/>&lt;param name="encode-values" value="false"/> ![](/images/icons/contenttypes/comment_16.png) Posted by lesnet at ott 23, 2015 15:53 |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Thanks Leslie. I've added your snippet in the page. ![](/images/icons/contenttypes/comment_16.png) Posted by italorossi at ott 26, 2015 10:12                                                                                                                                                                           |
