...
| Shouldn't the XML attribute syntax be escaped since it contains &lt; and > to be valid? If so, would the below be correct? &lt;api name\="user\_name" description\="Return Name for extension" syntax="&lt;exten&gt;" parse="(.\*)" destination="user\_data" argument="$1@default var effective\_caller\_id\_name"/> ![](/images/icons/contenttypes/comment_16.png) Posted by wralphcook at giu 14, 2015 11:23 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
