...
# mod_dptools: IVR Menu 
 ...
 Created by  Luan Fonseca de Farias, last modified by  Emmanuel Schmidbauer2 on 2016.12.29
...
| Sometimes IVR menu got error " Too many levels of **recursion** " ![](/images/icons/contenttypes/comment_16.png) Posted by livem at lug 13, 2016 03:13                                                                                                                                                                                                                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| That is a hard-coded limitation, if you call other menus recursively via the \`menu-sub\` action more than 12 times, it will exit the menu without executing it.See "Nesting IVRs" from <https://www.packtpub.com/books/content/freeswitch-utilizing-built-ivr-engine> for an alternative if menu-sub cannot be used (i.e. add an extension that invokes an IVR). ![](/images/icons/contenttypes/comment_16.png) Posted by Lekensteyn at lug 27, 2016 11:40 |
| Is that wil cause freeswitch **crash** ? ![](/images/icons/contenttypes/comment_16.png) Posted by livem at lug 27, 2016 23:42                                                                                                                                                                                                                                                                                                                               |
| **confirm-macro** **confirm-attempts**Can add some example codes with this two options ? ![](/images/icons/contenttypes/comment_16.png) Posted by livem at set 19, 2016 03:37                                                                                                                                                                                                                                                                               |
