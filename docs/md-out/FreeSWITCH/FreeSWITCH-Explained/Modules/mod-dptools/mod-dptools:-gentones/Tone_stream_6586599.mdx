...
# Tone_stream 
 ...
 Created by  Gabriel de Medeiros Galvão, last modified by  Attila Gulyas on 2019.10.25

TTML

Outside of [mod\_dptools: gentones](../6586546.mdx#about), `tone_stream` is also used with [TTML](./Tone-stream/TTML_27591313.mdx#usage) files (see [Freeswitch for new people](../../../[DEAD/Freeswitch-for-new-people_13173027.mdx#about) and [XML Dialplan](../../../Dialplan/XML-Dialplan/index.mdx#why)).
