...
# mod_dptools: hangup 
 ...
 Created by  Maximiliano Guerra de Medeiros, last modified by  Attila Gulyas on 2020.08.04
...
* [2\. Troubleshooting](#2-troubleshooting)  
   * [2.1 A leg wouldn't disconnect after calling hangup](#21-a-legcall-legs5f7143972html-wouldnt-disconnect-after-calling-hangup-)
...
### 2.1 [A leg](../../Introduction/Call-Legs_7143972.mdx#0-about) wouldn't disconnect after calling `hangup` 
...
[hangup\_after\_bridge](../../../Channel-Variables-Catalog/hangup_after_bridge_16352708.mdx#-freeswitch--hangup_after_bridge-) variable is also worth checking when FreeSWITCH™ didn't hang up the A leg when B is terminated.
