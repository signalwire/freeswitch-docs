...
<SignalWireCallout
  ...
  page="scripting"
  linkText="See the SignalWire SDK">

The SignalWire SDK runs call logic as ordinary Python or TypeScript services: no `mod_lua` embedding, no interpreter inside the switch. The same SDK builds hosted voice AI agents that follow steps you define in code.
