...
title: "Chapter 42: Call-Setup Failures"
...
sidebar_label: "42. Call-Setup Failures"
---
...
<SignalWireCallout
  title="Setup failures without the packet capture"
  href="https://signalwire.com/docs/apis"
  page="call-setup-failures"
  linkText="See the REST APIs">

When SignalWire's hosted platform carries the call, the SIP conversation with carriers is its job; your side is an API request and a status callback. Failed calls surface as error codes and logs you query, not INVITE traces you capture.
