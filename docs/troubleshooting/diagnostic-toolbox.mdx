...
title: "Chapter 39: The Diagnostic Toolbox"
...
sidebar_label: "39. The Diagnostic Toolbox"
---
...
<SignalWireCallout
  title="Diagnostics as an API"
  href="https://signalwire.com/docs/apis"
  page="diagnostic-toolbox"
  linkText="See the REST APIs">

On the hosted platform the diagnostic surface is logs and webhooks: every call and message is a resource with state history you can query. There is no console to attach and no log level to raise.
