...
<SignalWireCallout
  title="The trace, already collected"
  href="https://signalwire.com/docs/apis"
  page="reading-traces-cdr"
  linkText="See the REST APIs">

SignalWire records every call, message, and fax as queryable log resources, with webhooks pushing state changes as they happen. Per-call detail is in the dashboard, with no SIP trace to capture on a box.
