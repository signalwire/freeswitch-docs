...
title: "Chapter 40: Registration Problems"
...
sidebar_label: "40. Registration Problems"
---
...
<SignalWireCallout
  title="Registration, operated for you"
  href="https://signalwire.com/docs/platform/voice/sip/trunking"
  page="registration-problems"
  linkText="See hosted SIP">

When endpoints register to SignalWire's hosted SIP instead of your box, the registrar, its certificates, and its NAT handling are operated by the platform. The debugging in this chapter shrinks to your endpoints alone.
