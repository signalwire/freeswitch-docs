...
<SignalWireCallout
  title="One-way audio is a self-hosting problem"
  href="https://signalwire.com/docs/platform/getting-started"
  page="audio-problems"
  linkText="See the hosted platform">

Most one-way audio traces to NAT between your box and the far end. On SignalWire's hosted platform the media edge is operated for you, and this chapter's failure class is the platform's to solve.
