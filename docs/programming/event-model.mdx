...
title: "Chapter 44: The Event Model"
...
sidebar_label: "44. The Event Model"
---
...
<SignalWireCallout
  title="The event stream, as a service"
  href="https://signalwire.com/docs/server-sdks/guides/relay-client"
  page="event-model"
  linkText="See the RELAY realtime SDK">

RELAY, SignalWire's realtime WebSocket API, delivers the same idea as the FreeSWITCH event system: subscribe to call events and react from your own process, with typed Python and TypeScript SDKs. Webhooks cover the fire-and-forget cases.
