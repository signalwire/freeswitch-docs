...
<SignalWireCallout
  title="Fewer events, already typed"
  href="https://signalwire.com/docs/server-sdks/guides/relay-client"
  page="events-catalog"
  linkText="See the RELAY realtime SDK">

SignalWire's hosted platform emits call, message, and fax events over RELAY (a realtime WebSocket API) and webhooks, typed and documented per resource. The catalog you handle is the one your application subscribes to.
