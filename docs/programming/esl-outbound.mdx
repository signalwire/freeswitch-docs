...
<SignalWireCallout
  title="Outbound ESL without the listener"
  href="https://signalwire.com/docs/server-sdks/guides/relay-client"
  page="esl-outbound"
  linkText="See the RELAY realtime SDK">

Outbound ESL hands a call to your server. SignalWire does the same by fetching SWML, a JSON/YAML call-control document, from your endpoint, or by streaming the call to a RELAY WebSocket application. Same control, no listener socket on the switch.
