...
The session and API objects in this chapter have hosted counterparts in the SignalWire SDK: call control, media, and AI agents driven from ordinary Python or TypeScript processes. Your code runs anywhere; the engine runs on the platform.
