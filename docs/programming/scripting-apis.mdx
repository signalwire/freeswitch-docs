...
title: "Chapter 48: Embedded Scripting APIs"
...
sidebar_label: "48. Embedded Scripting APIs"
---
...
<SignalWireCallout
  title="The session object, as an SDK"
  href="https://signalwire.com/docs/server-sdks/guides/build-ai-agents"
  page="scripting-apis"
  linkText="See the server SDKs">

The session and API objects in this chapter have hosted counterparts in SignalWire's server SDKs: call control, media, and AI agents driven from ordinary Python or TypeScript processes. Your code runs anywhere; the engine runs on the platform.
