...
title: "Chapter 36: Connecting Two FreeSWITCH Servers"
...
sidebar_label: "36. Connecting Two FreeSWITCH Servers"
---
...
<SignalWireCallout
  title="The same pattern, with the platform as Box B"
  href="https://signalwire.com/docs/apis/rest/freeswitch-connector"
  page="recipe-box-to-box"
  linkText="See the FreeSWITCH Connector">

The gateway in this chapter is also how a box reaches the hosted platform. Point it at SignalWire instead of a second box, and the far end can be any SIP endpoint, phone number, or AI agent:

```yaml
- connect:
    to: "sip:2001@office-b.example.sip.signalwire.com"
```

A FreeSWITCH Connector resource represents each box inside the platform, so hybrid deployments route between self-hosted and hosted the way this recipe routes between boxes.
