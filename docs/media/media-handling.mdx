...
sidebar_position: 2
id: media-handling
slug: /media-and-codecs/handling
title: "Chapter 17: Media Handling"
description: "Control RTP media flow with the three media modes, plus early media, late negotiation, RTP timeouts, jitter buffering, and SRTP."
...
<SignalWireCallout
  title="The media path, operated for you"
  href="https://signalwire.com/docs/platform/voice/sip/trunking"
  page="media-handling"
  linkText="See hosted SIP">

On SignalWire's hosted platform, SRTP, NAT traversal, and the media path are the edge's job, on this same engine. Bypass, proxy, and re-invite trade-offs stop being your configuration; endpoints negotiate with a platform built to face the public Internet.
