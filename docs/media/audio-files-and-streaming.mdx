...
<SignalWireCallout
  title="One line of recording, storage included"
  href="https://signalwire.com/docs/swml/reference/calling/record-call"
  page="audio-files"
  linkText="See record_call in SWML">

`record_call` in SWML, SignalWire's JSON/YAML call-control markup, records a call in one line. Files land in your project with URLs and webhooks; formats, disk, and rotation are handled for you.
